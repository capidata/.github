...
### Método: o materialismo dialético como operação

A estrutura do argumento é o próprio método. A progressão dos cinco movimentos (da cena autobiográfica à tradição filosófica, da formalização matemática à arquitetura territorial, e desta à conjuntura de 2026) reproduz a operação que Hegel chamou de aufheben: cada nível de análise nega o anterior, preserva o que tinha de verdadeiro nele, e eleva o conjunto a um plano de maior concretude. O diagnóstico pessoal do bullying no recreio (caps. I-II) é negado enquanto caso individual e preservado enquanto mecanismo estrutural quando reaparece como ambitio em Spinoza (cap. III), como discurso do Mestre em Lacan (cap. IV), como assujettissement em Foucault (cap. V), como edipianização em Deleuze e Guattari (cap. VI), como aderência ao opressor em Freire e colonialidade do desejo em Rolnik (cap. VII). Cada reposição do mecanismo aumenta a resolução sem abandonar a experiência que o originou.

Marx e Ilyenkov desenvolveram esse método no plano da economia política: partir do concreto sensível (a mercadoria individual), abstrair as determinações que o governam (valor, trabalho, mais-valia), e retornar ao concreto pensado (o sistema capitalista como totalidade articulada). O mesmo procedimento opera aqui: parte da experiência vivida (o recreio, a escola, o território), abstrai o mecanismo universal que a determina (o desejo projetado em suas formas escalares), formaliza-o em estruturas precisas (teoria dos jogos, termodinâmica de sistemas dissipativos, espaço tridimensional de potência coletiva), e retorna à prática com capacidade transformadora ampliada (a Comunidade-Nação em sete camadas, a federação transversal, os protocolos de conflito).

O movimento não é linear. A cada transição de capítulo, o argumento retorna ao que já construiu para reorganizá-lo à luz do que acrescenta. Spinoza (cap. III) é revisitado por Lacan (cap. IV) quando das Ding marca o limite do conatus, e ambos são revisitados pela teoria da complexidade (cap. XIII) quando Prigogine demonstra que o conatus opera como estrutura dissipativa. A Coda volta ao recreio, mas agora o recreio contém todo o aparato conceitual que o ensaio construiu. O método espiral substitui o método linear: cada volta passa pelo mesmo ponto com resolução maior.

### Posição epistemológica: pós-modernidade progressista

A posição epistemológica que sustenta o argumento recusa dois extremos. O primeiro é o modernismo prescritivo: a crença de que existe uma ciência universal, um sujeito neutro de conhecimento e um programa correto que, aplicado, resolve a contradição social. A filosofia da libertação de Dussel (cap. VII), a crítica de Ferreira da Silva à separabilidade (cap. VII) e a cosmotécnica de Yuk Hui (cap. XX) demonstram que a pretensão de universalidade é ela mesma um dispositivo colonial. O segundo extremo é o pós-modernismo resignado: a recusa de toda pretensão de verdade, o relativismo que trata cada narrativa como equivalente e que, ao negar a possibilidade de conhecimento emancipatório, entrega a disputa epistêmica ao mais forte.

Paulo Freire, no trabalho tardio (cap. IX), nomeou a terceira posição: pós-modernidade progressista. Aceitar a crítica pós-moderna à metanarrativa totalizante (não existe programa que prescreva o futuro) sem abrir mão da transformação coletiva (existem condições de possibilidade que podem ser deliberadamente construídas). A ciência própria de Fals Borda (cap. VII), a investigación-acción participativa, o círculo de cultura freireano e a ecologia dos saberes de Boaventura de Sousa Santos operam nessa posição. O conhecimento válido é aquele que serve a quem vive o problema. É produzido _com_ o povo, verificado pela práxis, e corrigido pelo confronto com a experiência. A verdade existe, mas é situada, parcial e transformável.

A situacionalidade não invalida o argumento. Restringe seu domínio de validade e explicita suas condições de produção. O texto se escreve desde Pernambuco, desde a periferia do capitalismo digital, com categorias europeias (Spinoza, Lacan, Foucault) e periféricas (Freire, Fanon, Rolnik, Krenak, Ferreira da Silva) articuladas pela experiência territorial. A pretensão de universalidade que um tratado filosófico do centro imperial poderia alegar é aqui substituída por uma pretensão de transferibilidade: o mecanismo diagnosticado (o desejo projetado) opera em Hallencourt e em Borborema com a mesma estrutura formal. A verificação dessa transferibilidade é empírica, não axiomática.

### Acoplamento interdisciplinar: exatas e humanas como operação única

O argumento mobiliza simultaneamente tradições que a academia separa em departamentos incomunicáveis. A psicanálise de Lacan e a teoria dos jogos de Axelrod. A ontologia de Spinoza e a termodinâmica de Prigogine. A analítica do poder de Foucault e o design de mecanismos de Maskin. A fenomenologia dos encontros transformadores e o Índice de Pobreza Multidimensional de Alkire-Foster. A separação disciplinar é recusada porque o corpo que sofre não sofre "psicanaliticamente" apenas ou "economicamente" apenas. Sofre a conjunção. O método que separa falsifica o objeto.

O capítulo XIII formaliza o acoplamento: as ciências humanas definem o campo (a experiência, os conceitos, os critérios éticos), as ciências exatas operam dentro dele (medem, modelam, projetam mecanismos). A teoria dos jogos prova que cooperação é sustentável sob condições específicas, mas não diz o que vale a pena cooperar para. O IPM de Alkire-Foster mede privação multidimensional, mas quem vive a privação decide quais dimensões importam. O Valor de Shapley distribui com justiça matemática, mas a comunidade decide se distribuição proporcional é o que quer. A formalização é serva do argumento. Cada fórmula que aparece no texto é imediatamente traduzida em linguagem concreta com exemplo material. Quando a fórmula substitui o argumento em vez de complementá-lo, algo falhou.

A impossibilidade de formalização completa (demonstrada no cap. IV via das Ding/Westerink e no cap. XX via Russell/alinhamento de IA) é recurso epistemológico, não defeito. Garante que o framework opere como condição de possibilidade (discurso do analista: mostra o mapa sem prescrever o destino) e não como programa (discurso do mestre: prescreve o que o sujeito deve fazer). A diferença entre condição e programa é a diferença entre ciência que emancipa e ciência que domina.

### Cinco critérios de validação interna

Cada capítulo responde a cinco critérios que garantem coerência e rigor.

**1. Coerência conceitual.** Cada categoria introduzida é retomada nos capítulos seguintes com maior precisão. O desejo projetado que aparece no recreio (cap. I) reaparece como ambitio em Spinoza (cap. III), como discurso do Mestre em Lacan (cap. IV), como governamentalidade algorítmica em Foucault ampliado por Rouvroy (cap. V), como desejo projetado sobre a mulher em Federici/Tronto (cap. VII), como ambitio automatizada no algoritmo preditivo (caps. V, VIII, XX). Os conceitos nomeiam com precisão crescente o mesmo mecanismo em escalas diferentes. Nenhum conceito é introduzido sem ser retomado.

**2. Movimento dialético (aufheben).** O diagnóstico pessoal se amplia ao tornar-se estrutural. A filosofia se formaliza ao tornar-se matemática. A matemática se materializa ao tornar-se arquitetura territorial. A arquitetura se historiciza ao confrontar a conjuntura de 2026. Cada transição de capítulo preserva, nega e eleva o anterior.

**3. Materialidade.** Toda abstração é ancorada no que já existe. Spinoza, Lacan, Foucault funcionam como descritores precisos do que a prática já realiza. O Banco Palmas (130+ bancos comunitários), o MST (450 mil famílias assentadas), os quilombos (3.800+ comunidades certificadas), as cozinhas comunitárias, os assentamentos agroecológicos, a biotecnologia soberana cubana, a soberania digital chinesa provam que a teoria descreve práticas existentes. Quando a teoria afirma algo que nenhuma experiência material confirma, o argumento é honesto sobre o caráter especulativo da afirmação.

**4. Clareza através de densidade controlada.** O ensaio não é paper acadêmico. É texto que quer ser lido por quem vive o problema. O português brasileiro, o vocabulário da periferia, as referências ao rap e ao coco de roda tanto quanto à filosofia, tudo isso recusa que a compreensão seja propriedade privada de quem pode pagar a pedagogia elevada. A operação que Rancière chamou de redistribuição do sensível acontece aqui na forma: cada capítulo rejeita a separação disciplinar que torna a teoria inacessível. Um parágrafo pode carregar até 130-140 palavras quando cada sentença tem peso conceitual. Acima disso, precisa de respiração. As quebras textuais não surgem arbitrariamente, mas em pontos de transição semântica.

**5. Alinhamento composicional.** Todo capítulo responde ao critério composicional triplo: amplia ou diminui a potência de agir dos corpos que compõem esta rede? O que faz com o que sobra? Expande ou contrai o espaço de possibilidades futuras? Os oito princípios invioláveis (Soberania, Anti-colonialismo, Assimetria como dado, Ilegibilidade estratégica, Conatus coletivo, Commons, Prática sobre discurso, Autocorreção permanente) funcionam como restrições de contorno. Emergem da própria lógica interna do argumento, do mesmo modo que os princípios de Ostrom emergem da prática dos commons. Quando um capítulo é coerente, dialético, materialista, claro e alinhado com esses cinco critérios, ele está pronto.

### Processo de verificação

Cada capítulo passou por verificação em cinco fases. Primeira, leitura totalizante: qual contradição central o capítulo resolve? Segunda, análise das determinações: como os cinco critérios atuam nele? Terceira, síntese de ressalvas: onde o argumento carrega densidade excessiva, onde precisa de respiração, onde afirma mais do que a evidência sustenta? Quarta, avaliação formal: a forma serve ao conteúdo ou o prejudica? Quinta, retorno à totalidade: o capítulo conecta coerentemente ao anterior e ao seguinte?

A verificação empírica segue o ciclo iterativo que o capítulo XIII formaliza: medir o estado atual, agir com base no critério composicional, medir novamente, corrigir. O Princípio VIII (autocorreção permanente) se aplica ao próprio texto. O ensaio aceita ser parcialmente destruído pelo confronto com quem vive empiricamente o que ele teoriza. Um texto que se defende é menos útil do que um texto que se deixa transformar. A pretensão não é de ter acertado. É de ter nomeado com precisão suficiente para que a correção seja possível.

### Limites explícitos

O argumento tem limites que a honestidade intelectual obriga a declarar. O autor escreve desde posição masculina, branca (no contexto nordestino mestiço), urbana (Recife), com acesso a universidade pública e ferramentas digitais. Os capítulos sobre gênero (cap. VII), raça como dispositivo ontológico (cap. VII) e corpos não-normativos (cap. IX) são tentativas de incluir o que a posição do autor não vive de dentro. Tentativas necessárias e insuficientes. A autocorreção permanente se aplica aqui com peso especial: esses trechos são os mais vulneráveis à revisão por quem vive o que eles teorizam.

O texto foi produzido com apoio de ferramenta de inteligência artificial generativa. O uso de IA na produção de conhecimento é ele mesmo objeto de análise no cap. XX (alinhamento de IA como problema lacaniano). A IA que auxiliou a escrita opera sob as mesmas restrições que o capítulo V diagnostica: padrões treinados em corpora que carregam viés colonial, racial e de classe. A autocorreção exigiu revisão humana contínua, verificação de fontes, e confronto com a experiência material que nenhum modelo de linguagem acessa. O resultado é texto de autoria humana com assistência computacional, onde a responsabilidade pelo argumento, seus acertos e seus erros, pertence integralmente ao autor.

## I. A ferida e o mecanismo

### A cena original

Minha dedicação aos estudos era o exemplo que os pais dos meus colegas usavam para humilhá-los e agredi-los emocionalmente dentro de casa. E estes me colocavam pra apanhar na escola, e me humilhavam. E estes faziam revolução contra seus pais através de mim. E eu sabia disso.

Por que eu revidaria? Os pais deveriam ter perdido as suas vidas enquanto me agrediam. O moleque que me batia era só o mensageiro de uma violência que não pertencia a ele, mas ao desejo projetado de um adulto que não soube lidar com a própria frustração.
...
<mermaid src="cap-I" description="Trauma como cena original que atravessa família, instituição e Estado, tornando a subjetividade um campo de batalha entre desejos projetados."></mermaid>


## II. A célula primordial do câncer social

### O amor como posse

O poder através do amor projetado, como atenção condicionada disfarçada de afeto incondicional, é a célula primordial do câncer da teia social.
...
O cansaço solitário que Han diagnostica descreve a experiência fenomenológica da atomização. Todos isolados, todos perdendo, ninguém conseguindo romper o ciclo porque a cooperação exige encontro e o encontro exige tempo que a precariedade negou.
...
Quando corpos se encontram e compõem relações que aumentam mutuamente suas potências de agir, o que surge é alegria. Quando se decompõem, tristeza.

A ética daí derivada segue lógica composicional. Bem é aquilo que amplia a potência de agir, mal é aquilo que a diminui. Nenhuma moral transcendente. Apenas a geometria dos encontros.

### A ambitio e o veneno da projeção

Na Ética III, Proposição 31 e seu Corolário, Spinoza descreve a ambitio. Cada pessoa se esforça para fazer com que todos os demais amem o que ela ama e odeiem o que ela odeia. Os humanos tendem a imitar os afetos daqueles que percebem como semelhantes. Disso resulta que todo mundo tenta fazer todo mundo viver conforme o seu próprio temperamento.

> "Nós não desejamos algo porque o julgamos bom; ao contrário, chamamos bom aquilo que desejamos.", Spinoza, Ética III, P9S

A ambitio é a mecânica formal do desejo projetado. O pai que projeta sobre o filho está acionando a ambitio, quer que o filho ame o que ele ama, tema o que ele teme, aspire ao que ele aspirou e não alcançou. O sistema não é exceção patológica. É a condição padrão da sociabilidade humana quando não há trabalho ativo de composição.

### Potentia e potestas: uma distinção que não é simples

A distinção entre potentia e potestas (entre poder como capacidade de agir e poder como dominação) percorre a teoria política spinoziana. Uma precisão que o uso político desta distinção frequentemente obscurece: a potestas não é simplesmente má.

No Tratado Político, Spinoza é mais cauteloso do que no Spinoza de Deleuze e Negri. A potestas é o poder constituído que existe porque a potência constituinte ainda não encontrou sua forma adequada de expressão.
...
Essa imagem de si mesmo é ambitio coletiva. O Brasil se projeta sobre si mesmo como país da harmonia racial precisamente para não reconhecer e reparar a hierarquia que o constitui.
...
### As paixões alegres como caminho para a razão

A passagem da servidão à liberdade em Spinoza não acontece por ato de vontade, mas por aumento de potência de agir via encontros que aumentam a alegria. Essa é a porta que a teoria spinoziana abre. Não mediante a culpa, a repressão, a moral, mas mediante encontros que ampliam a capacidade de afetar e ser afetado. A alegria sinaliza aumento de potência. O medo, a culpa, a depressão, paixões tristes que reduzem potência, aprisionam o pensamento. A alegria o libera.
...
### VP3 e o programa ético

Proposição 3 da Parte V da Ética. Um afeto que é paixão deixa de ser paixão assim que formamos uma ideia clara e distinta dele.

A transformação ética não consiste em reprimir o afeto nem sublimá-lo num ideal transcendente, mas em torná-lo inteligível, compreender sua causa, sua mecânica, o que ele quer de fato quando age como age. Uma paixão compreendida é o começo de uma ação.

<mermaid src="cap-III" description="Spinoza: o conatus (essência é perseverar no ser) é capturado pela ambitio (desejo de aprovação). Potentia (potência de agir) é bloqueada por potestas (poder sobre o outro). VP3: a paixão compreendida é o início de uma ação."></mermaid>


## IV. Lacan: o sujeito forjado pelo desejo do Outro

### O desejo do Outro

Para Lacan, _le désir de l'homme est le désir de l'Autre_. O desejo do sujeito é o desejo do Outro. Isso carrega pelo menos três significados simultâneos. Desejo pelo Outro, desejo de ser desejado pelo Outro, e desejo estruturado pela linguagem do Outro. O sujeito não chega ao mundo com um desejo próprio. O desejo emerge do campo significante do Outro. O que chamamos de "nosso desejo" é sempre já o traço que o Outro deixou.

### O estádio do espelho, a ficção do ego e a colonização

No estádio do espelho, a criança, entre 6 e 18 meses, identifica-se com sua imagem especular. Imagem de coerência que contrasta com a experiência real de fragmentação. O ego é uma ficção necessária mas é ficção. A criança se vira pro adulto que a carrega, buscando ratificação do grande Outro. "Sou eu isso?"

Fanon desloca o estádio do espelho do consultório para a situação colonial. O negro está submetido a um estádio do espelho racializado. O espelho que a civilização branca oferece devolve uma imagem de inferioridade. Mas o espelho colonial não é apenas imaginário. Vem sustentado por exércitos, economias e instituições inteiras. O sujeito colonial não apenas imagina sua inferioridade. Ele a vive em cada abordagem policial, em cada escola que desqualifica seu sotaque, em cada instituição que o trata como objeto antes de ser sujeito.
...
O nordestino não precisa deixar de ser nordestino para ser revolucionário. O *pretuguês* de Lélia Gonzalez não é resíduo a ser superado, mas o sintoma com o qual o sujeito se identifica como ato político.

Isso corresponde ao ch'ixi de Rivera Cusicanqui, coexistência de contrários em tensão produtiva, sem síntese que apague a contradição. A potência está exatamente na tensão irresolvida.
...
A fuga não é integração do sintoma nem recaída, mas terceira via, forçada pela hostilidade total do ambiente ao desejo que emergiu. A ética do desejo precisa reconhecer essa forma de acting out não como fracasso mas como sobrevivência. E trabalhar para que as condições coletivas tornem a fuga menos necessária.

### Das Ding: o vazio que organiza o desejo

No Seminário VII, Lacan abandona Spinoza num ponto preciso. O conatus spinoziano é esforço de perseverar no ser, composição que amplia potência. Lacan localiza no centro dessa composição um vazio inacessível: das Ding, a Coisa. O objeto absolutamente primeiro que o sujeito procura e que nunca encontra, porque não é objeto perdido. Nunca existiu como objeto. É a marca de uma falta constitutiva em torno da qual o desejo se organiza.

Herman Westerink rastreia o caminho por onde Lacan chega a das Ding: Lutero lendo Paulo. "Sem a lei, o pecado está morto" (Romanos 7:8). A lei não produz virtude. Produz a consciência da transgressão e, com ela, o desejo de transgredir. A proibição cria o que pretende impedir. A formulação importa para a política porque destrói a ilusão de que prescrever comportamento ético gera comportamento ético. Prescrever a solidariedade gera conformidade performática, e o sujeito que performa solidariedade por obediência à prescrição já está operando no registro do eu falso.

A consequência para a ética do desejo é direta. O capítulo IX formula "condições, não programas" como escolha política. Das Ding fornece a fundamentação psicanalítica dessa escolha. Um programa prescreve o que o sujeito deve desejar. Mas o desejo se organiza em torno de um vazio que nenhuma prescrição alcança. Quando o programa tenta preencher esse vazio, o sujeito ou obedece sem desejar (eu falso coletivo) ou transgride por transgredir (acting out). Criar condições é construir ao redor do vazio sem pretender preenchê-lo. A cozinha comunitária, o círculo de cultura, a assembleia territorial funcionam quando deixam o vazio no centro, quando não dizem ao sujeito o que ele deve encontrar ali.

### O excedente do conatus: Spinoza e Lacan como prolongamento

Alenka Kordela, em _Surplus: Spinoza, Lacan_, demonstra que a relação entre os dois não é oposição simples. O conatus, ao perseverar no ser, gera resto. Todo esforço de composição produz excedente que não pode ser reabsorvido pela composição que o gerou. Kordela identifica esse excedente como estruturalmente idêntico ao gozo lacaniano: o que sobra quando a necessidade foi satisfeita, o que insiste para além de qualquer objeto.

A implicação prática atravessa todo o argumento que se segue. Uma comunidade que compõe bem, que amplia potência de agir, que cria noções comuns genuínas, ainda assim gera excedente. Sem vias para esse excedente, a festa, o ritual, a arte, o gasto que o cálculo econômico chama de improdutivo, o resto retorna como conflito narcisista, cisma ou acting out. O capítulo XIX identifica três camadas de conflito na esquerda: ideológica, narcisista e material. A segunda, a desproporcional, frequentemente tem raiz nesse excedente sem via de expressão. A militante que dedica anos à organização e explode por um desacordo menor pode estar reagindo ao acúmulo de excedente que a organização não soube processar.

Georges Bataille nomeou esse excedente como dépense, gasto improdutivo. A parte maldita da economia é o que toda comunidade precisa gastar sem retorno: festa, erotismo, sacrifício, arte. O capitalismo absorve esse gasto e o converte em mercadoria (a indústria do entretenimento). Os commons que duram, os que Ostrom estudou e os que o MST pratica, reservam espaço para dépense coletiva. A mística do MST, a festa junina do assentamento, o forró depois da assembleia, são vias para o excedente. Não são luxo nem distração. São condição de sustentabilidade da própria composição.

O critério composicional spinoziano, "amplia ou diminui a potência de agir?", opera como primeiro registro ético. Na fronteira onde das Ding resiste à simbolização, onde o excedente confronta o sujeito, outro registro se ativa. A pergunta complementar: "e o que faz com o que sobra?"
...
## V. Foucault: o poder capilar, a forja da subjetividade e as práticas de liberdade

Foucault desmonta a ilusão de que o poder é algo que se possui. O poder está em toda parte, não porque abraça tudo, mas porque vem de toda parte. E onde há poder, há resistência.

### A disciplina e os corpos dóceis

As instituições disciplinares (escola, família, prisão, hospital) projetam expectativas normativas sobre os corpos, criando corpos dóceis. O Panóptico induz um estado de visibilidade consciente e permanente que assegura o funcionamento automático do poder. A formulação mais devastadora. A alma é o efeito e instrumento de uma anatomia política; a alma é a prisão do corpo.

No assujettissement, a palavra carrega os dois sentidos ao mesmo tempo. Sujeito a alguém pelo controle e pela dependência. E atado à própria identidade por uma consciência de si. O poder categoriza o indivíduo, marca-o pela sua individualidade, liga-o à sua identidade, impõe-lhe uma lei de verdade que ele deve reconhecer.

A escola que ensina o nordestino que seu sotaque é "errado" não está apenas transmitindo um preconceito. Está instalando uma tecnologia de subjetivação que o sujeito vai acionar sobre si mesmo pelo resto da vida.
...
O esgotamento, essa depressão que o capitalismo diagnóstico, é ele próprio um fenômeno biopolítico. A destruição do conatus em escala populacional como estratégia de governamentalidade. O corpo que se esgota trabalha mais, oferece menos resistência, internaliza que sua fadiga é fracasso pessoal e não produto de uma máquina que o esgota deliberadamente.

### Governamentalidade neoliberal: a tecnologia do eu mercado

A governamentalidade em Foucault, esse "art of governing", refere-se ao tipo específico de poder característico da modernidade. Menos baseado na lei e na soberania, mais apoiado na administração de populações através de saberes, estatística, medicina, economia. O neoliberalismo não significa ausência de governo, mas governo radical que governa não apenas pelo constrangimento, mas pela implantação de uma racionalidade econômica em cada decisão do sujeito.

O Bolsa Família exemplifica essa tecnologia com precisão. Vai além da transferência de renda e funciona como desenho de subjetividade. A condicionalidade (frequência escolar das crianças, acompanhamento pré-natal) não funciona como punição pelo não-cumprimento, mas como criação da obrigação do auto-monitoramento. A mãe que recebe o benefício internaliza a responsabilidade fiscal. É ela quem "decide" gastar com educação porque compreendeu que seu corpo e o corpo de seus filhos são capital humano que exigem investimento.

O programa que permitiu, entre 2002 e 2015, que famílias saíssem da pobreza extrema é ele próprio a operação final de governamentalidade. O pobre que se torna gestor econômico responsável de seu próprio governar.

Não é erro ou demonização dizer isso. É descrição de como funciona. A condicionalidade como tecnologia do eu permite que o Estado reduza seu próprio aparato (não precisa enviar fiscais porque as mães se fiscalizam) e simultaneamente cria sujeitos para quem a internalização do cálculo econômico é o horizonte permanente do pensar.

O que muda quando o governo muda não é a estrutura governamental do Bolsa Família, mas as condicionalidades se tornam mais rígidas, mais humilhantes, direcionadas à punição. A mesma tecnologia do eu é reconfigurada para produzir submissão em vez de agência. O poder sobre a vida que governa a vida e que, no varejo da descentralização, ensina a cada sujeito a governar-se através dos termos do mercado.

### O espaço cibernético como colonização dos outros espaços

A disciplina opera em espaços fechados: a escola, a fábrica, o hospital, a prisão. A biopolítica opera sobre a população como fenômeno estatístico. A governamentalidade neoliberal opera dentro do sujeito, que calcula a si mesmo como empresa. Cada modo de poder tem sua topologia. O espaço cibernético inaugura uma topologia diferente: é um espaço que se sobrepõe a todos os outros e os remodela por dentro.

A rua onde acontece o coco de roda agora é também o espaço do celular que filma, transmite, gera dados de localização e alimenta perfis comportamentais. A cozinha comunitária onde mulheres nomeiam coletivamente o sofrimento agora é também o espaço do grupo de WhatsApp que a organiza, e o WhatsApp pertence ao Meta, que extrai metadados de quem fala com quem, quando, com que frequência. A assembleia onde se delibera sobre a terra agora é também o espaço do algoritmo que monitora quais lideranças se comunicam com quais bases. O quarto onde o casal discute agora é também o espaço do assistente de voz que escuta permanentemente. Nenhum espaço de convivência escapa da sobreposição cibernética. A cibernética não é um espaço entre outros. É um meta-espaço que coloniza todos os demais.

O coletivo Tiqqun, na _Hipótese Cibernética_, formula com precisão: a cibernética funciona como tecnologia de governo que integra disciplina, biopolítica, polícia e publicidade num aparato único que busca "um grau ótimo de comunicação entre as partes". O controle se deslocou da exploração do trabalho para a esfera da circulação. A plataforma captura desejo e comportamento no ponto do consumo, da troca, da relação afetiva, e não apenas no chão da fábrica. O capitalismo de plataforma realiza o que Foucault descreveu como governamentalidade sem precisar mais do Estado como operador principal. A infraestrutura é privada, transnacional e opaca.

### A governamentalidade algorítmica: preempção, não repressão

Walter Benjamin descreveu em 1935 o inconsciente óptico: a câmera revela o que o olho humano não percebe. O algoritmo de Big Data é o inconsciente óptico do século XXI. Revela padrões de comportamento e desejo que o próprio sujeito desconhece. O feed personalizado sabe antes de mim que estou deprimido, que vou comprar, que mudo de opinião política quando estou cansado. A diferença em relação a Benjamin é estrutural: o inconsciente óptico ampliava a percepção humana. O inconsciente algorítmico a substitui. O sujeito não vê o que o algoritmo vê sobre ele.

Antoinette Rouvroy nomeia o que opera aqui como governamentalidade algorítmica. A distinção com Foucault é precisa. A disciplina julga e pune o desvio em relação a uma norma. A governamentalidade neoliberal incentiva e gerencia o sujeito como empreendedor de si. A governamentalidade algorítmica é a-normativa: não estabelece o que deve ser, não pune o desvio, não incentiva o cálculo. Prediz o que será e preempta o que poderia ser. O governo algorítmico visa "o excesso do possível sobre o provável": reduz o espaço de possibilidades antes que o sujeito perceba que tinha outras opções. A preempção dispensa explicação causal. Identifica padrões e age sobre eles. O cidadão não sabe por que foi alvo, o que torna a resistência epistemicamente impossível. Contra o que não se compreende, não se luta: apenas se obedece ou se desconecta.

Shoshana Zuboff nomeou a forma econômica como capitalismo de vigilância. O poder instrumentário governa pela predição e modificação comportamental em escala. O ambiente de escolha é reconfigurado antes que o sujeito perceba que está escolhendo. A arquitetura da plataforma decide quais opções aparecem, em que ordem, com qual carga emocional.

Alexander Galloway, em _Protocol_, descreve a arquitetura técnica desse controle. Em redes distribuídas, o controle opera por protocolo: regras técnicas (TCP/IP, DNS, HTTP) que formatam o espaço de ação possível. O protocolo não proíbe. Torna alternativas materialmente inviáveis. A plataforma que não oferece botão de "discordar", que não permite exportar dados, que não exibe conteúdo sem conta, não está censurando. Está arquitetando o possível. A diferença com a censura soberana (que diz "não") e com a disciplina (que pune quem faz) é que o protocolo torna certas ações impensáveis antes de serem tentadas.

### A captura cibernética do conatus

A ambitio spinoziana, o esforço de fazer com que todos vivam conforme o temperamento de quem projeta, encontra no algoritmo preditivo sua automação perfeita. A ambitio humana precisa de presença, de relação, de vínculo para operar. O algoritmo dispensa tudo isso. Modula o desejo de milhões simultaneamente, sem rosto e sem responsável.

A plataforma não reprime o conatus. Captura-o e redireciona-o. O desejo de conexão (o conatus que busca composição com outros corpos) é canalizado para o scroll infinito, onde cada interação gera dado que alimenta o modelo preditivo que modula a próxima interação. O desejo de reconhecimento (o conatus que busca ser visto por outro corpo) é canalizado para a economia de likes, onde cada validação gera métrica que alimenta o algoritmo de visibilidade. O desejo de ação coletiva (o conatus que busca ampliar potência com outros) é canalizado para o compartilhamento viral, onde a indignação gera engajamento que gera receita publicitária. Em cada caso, o conatus funciona. O sujeito sente que deseja, que age, que se conecta. A captura opera precisamente porque não bloqueia o desejo. O redireciona para circuitos que extraem valor sem devolver composição.

Wendy Chun descreve o mecanismo de captura como hábito. A plataforma não aparece como aparato de controle. Aparece como rotina: abrir o celular ao acordar, checar notificações, rolar o feed, responder mensagens. O hábito digital se instala abaixo do limiar da decisão consciente, no mesmo registro onde Foucault localizou o assujettissement. A fórmula de Chun: "hábito + crise = atualização". Cada atualização do aplicativo se disfarça de novidade enquanto reinstala a dependência repetitiva. O corpo que habitualmente abre o Instagram antes de conversar com quem está ao lado já cedeu o espaço do encontro ao espaço cibernético. A sobreposição é completa quando o hábito digital se torna a condição do encontro físico: "te mando a localização pelo WhatsApp", "vou postar a foto da cozinha comunitária", "marca a assembleia pelo grupo".

Matteo Pasquinelli, em _The Eye of the Master_, acrescenta a dimensão do trabalho. A inteligência artificial não imita a inteligência biológica. Captura e mecaniza a forma do trabalho social coletivo. Desde as máquinas calculadoras de Babbage até os modelos de linguagem, a IA espelha a inteligência analítica da cooperação social e da divisão do trabalho. O algoritmo governa o espaço de possibilidade da coordenação coletiva: torna certos modos de se encontrar mais fáceis (os que geram dados extraíveis) e outros mais difíceis (os que escapam à captura). A cozinha comunitária organizada por grupo de WhatsApp é visível, rastreável, modulável. A cozinha organizada boca a boca, de porta em porta, é ilegível. A segunda é mais trabalhosa, mais lenta, mais frágil. A primeira é mais eficiente, mais rápida, mais capturável. A escolha entre as duas é política.

### A dimensão racial do controle algorítmico

Safiya Noble demonstrou em _Algorithms of Oppression_ que os algoritmos de busca privilegiam a branquitude por design. Os dados de treinamento carregam o racismo histórico. O modelo de negócio prioriza os públicos com maior poder de compra. A ausência de pessoas racializadas no design dos sistemas garante que o viés não seja percebido como viés, mas como resultado "objetivo". Ruha Benjamin nomeou o mecanismo como New Jim Code: tecnologia aparentemente neutra que replica e aprofunda hierarquias raciais enquanto se apresenta como progresso. O policiamento preditivo, que direciona patrulhas a bairros periféricos com base em dados históricos de prisões, automatiza a vigilância colonial que Simone Browne (capítulo XV/Camada 6) rastreou desde a escravidão. A diferença é que o algoritmo torna a vigilância invisível e incontestável: o dado aparece como fato, não como decisão política.

Na periferia brasileira, a sobreposição é tripla. O jovem negro do Ibura está sob vigilância policial (soberania), sob autoexploração digital (governamentalidade neoliberal) e sob modulação algorítmica (governamentalidade cibernética) simultaneamente. O celular que ele usa para trabalhar no Uber (autoexploração) é o mesmo que gera os dados de localização que alimentam o policiamento preditivo (soberania) e o perfil comportamental que modula o que ele vê e deseja (cibernética). Três modos de poder convergem no mesmo objeto, no mesmo corpo, no mesmo território. A análise que captura uma camada de cada vez (Foucault, Mbembe ou Han separadamente) perde a convergência. A periferia exige articulação simultânea.

### A destruição cibernética das condições de encontro

O Princípio IV (ilegibilidade estratégica) tem duas faces. Ilegibilidade frente ao Estado extrator continua necessária. Ilegibilidade frente ao aparato algorítmico se tornou igualmente urgente. O sujeito precisa de zonas onde seu comportamento não é capturado, processado e devolvido como modulação. Sem essas zonas, o corpo vibrátil do capítulo X não tem onde vibrar: toda vibração é imediatamente capturada como dado.

A fenomenologia dos encontros transformadores (capítulo IX) pressupõe quatro movimentos: nomeação coletiva, reconhecimento, identificação de causalidade, ação emergente. O espaço cibernético ameaça cada um deles. A nomeação coletiva pressupõe que o grupo chega ao nome pelo próprio processo de conversar. O algoritmo nomeia antes: classifica populações em clusters, perfis, segmentos, antes que qualquer autodeterminação coletiva aconteça. A taxonomia imposta de cima substitui o nome que emerge de baixo. O reconhecimento pressupõe confronto entre sujeitos que se olham e se afetam mutuamente. O algoritmo é um Outro sem rosto: não se pode confrontá-lo, negociar com ele nem obter dele reconhecimento. A identificação de causalidade pressupõe que o grupo compreende por que sofre. A preempção algorítmica opera por correlação, sem causalidade. O sujeito sabe que algo mudou (o conteúdo que aparece, o preço que subiu, a conta que foi derrubada) mas não sabe por quê, e essa opacidade destrói a condição epistêmica do terceiro movimento. A ação emergente pressupõe que o grupo age de forma inesperada, reconfigurando o possível. A plataforma monitora, prediz e preempta a coordenação emergente em tempo real. O ciclo entre ação e aprendizado coletivo é interceptado e modulado antes de se tornar movimento político consciente.

A contraconduta (seção anterior deste capítulo) precisa ser pensada também no registro cibernético. A potência negativa que Han descreve (poder não-fazer, não reagir ao estímulo) ganha urgência específica: não abrir o celular durante a roda de conversa, não filmar a assembleia para postar, não organizar pelo grupo de WhatsApp quando é possível organizar de porta em porta. A lentidão deliberada, a opacidade escolhida, o encontro presencial sem mediação digital são contracondutas cibernéticas. Custam mais. Escalam menos. Produzem menos dado. E por isso preservam o espaço onde a nomeação coletiva pode acontecer sem ser capturada antes de existir.

<mermaid src="cap-V" description="Foucault: do poder disciplinar (corpos dóceis) à biopolítica (poder sobre a vida) à governamentalidade neoliberal (tecnologia do eu-mercado) à governamentalidade algorítmica (preempção cibernética do possível). A cibernética como meta-espaço que coloniza rua, cozinha, assembleia e quarto. A parresia e as contracondutas, incluindo contracondutas cibernéticas, são práticas de liberdade."></mermaid>


## VI. Deleuze e Guattari: o desejo produz realidade
...
O CsO não se opõe aos órgãos, mas ao organismo. O organismo é o estrato que impõe formas, funções e organização hierárquica sobre o corpo. O microfascismo age através de regimes moleculares. É fácil demais ser antifascista no nível molar sem ver o fascista dentro de si mesmo.

O bolsonarismo não se explica sem microfascismo. O regime molecular de afetos que persiste mesmo depois da derrota eleitoral, governando nos grupos de família, nos cultos neopentecostais, nas abordagens policiais.

### A máquina de guerra, o rizoma e a imanência
...
A estrutura arborescente do partido leninista tem origem no Politburo, ramos que recebem instruções de cima para baixo, folhas que executam. É ela mesma uma máquina de captura de potência. O Centralismo Democrático promete que a discussão de base chega ao cume. Na prática, realiza o inverso. A decisão desce, a discussão de base é reorganizada como obediência.

Deleuze e Guattari não apresentam uma alternativa organizativa clara, mas iluminam por que a forma importa tanto quanto o programa. Um programa revolucionário realizado através de máquina arborescente vai reterritorializar a potência que tentava liberar.

A federação transversal que o capítulo XIII propõe é tentativa de rizoma, sem cume que decide, sem folhas que obedecem, mas sem cair na ilusão anarquista de que organização é automaticamente traição. O rizoma é organização, mas através de pontos de sinergia entre agentes que tomam decisões localmente sem renunciar à coordenação em escala ampliada.

### A edipianização como regime simbólico familiar

O Anti-Édipo nomeia o mecanismo que o capítulo II descreveu como "desejo projetado". A edipianização é a operação pela qual a máquina desejante infinita é forçada a passar por uma máquina triangular, pai-mãe-criança. A criança que poderia desejar qualquer coisa é comprimida no triângulo edípico. A mãe é aquela que deve amar, o pai é aquela que proíbe. A criança é forçada a desejar dentro dessa grade. A neurose é resultado dessa compressão bem-sucedida. A psicose é resultado de uma compressão mal-feita, onde a máquina triangular não consegue capturar a máquina infinita.

O capitalismo, para Deleuze e Guattari, é o regime que resolveu a contradição. Descodifica, permitindo desejos que o patriarcado proibia. Reterritorializa, canalizando todos esses desejos para o consumo. O Édipo familiar é microforma de um édipo social. Reconhecer isso é começar a escapar da armadilha.

A edipianização é contínua porque o desejo projetado não para de agir. Toda vez que conseguimos sair de uma estrutura triangular caímos em outra. O trabalho de desedipianização não se conquista de vez, mas se pratica permanentemente.

### O devir-minoritário como saída

Mas como escapar da edipianização permanente? Deleuze e Guattari nomeiam um conceito que atravessa toda sua obra, o devir-minoritário. Não significa tornar-se minoria numericamente. Significa ser um vetor pelo qual o padrão normativo (a maioria como estado de coisas estabelecido) é desfeito. O homem branco heterossexual urbano de classe média não é maioria por número, mas porque é o padrão de medida, o ponto de referência em relação ao qual todos os outros são desvios. Devir-minoritário significa colocar esse padrão em variação permanente, agir na escala molecular, das práticas cotidianas, dos encontros, da subjetividade, onde a mudança molar (tomar o Estado, ganhar eleições) não chega.

A federação transversal só efetua transformação se produzir devenires-minoritários generalizados. Quando a maioria das pessoas começa a viver, pensar e desejar fora do padrão, o padrão desmorona, não por decisão consciente, mas por esgotamento de sua capacidade de capturar a vida coletiva.

Essa é a diferença entre revolução como evento (tomar o poder em momento decisivo) e revolução como prática (mudança contínua na escala onde o desejo é formado). Louis (Cap. XI) fez um devir-minoritário individual e solitário, pagando o preço de não ter coletivo que o acompanhasse.

A Camada 7 da arquitetura em sete camadas cria as condições para que o devir-minoritário seja coletivo. A cozinha solidária que acolhe sexualidades dissidentes, o mutirão que constrói com corpos fora da norma, o mapeamento comunitário que reconhece saberes que a escola oficial nega, esses são devenires-minoritários que não exigem sacrifício de quem os pratica.
...
<mermaid src="cap-VI" description="Deleuze e Guattari: o desejo produz realidade. CsO (corpo sem órgãos) como plano de imanência. Rizoma versus árvore hierárquica. O devir-minoritário como saída, contra o microfascismo interno."></mermaid>
...
Fals Borda inverte. O conhecimento válido é aquele que serve a quem vive o problema, não a quem o observa. Esse conhecimento é produzido _com_ o povo, não _sobre_ o povo.
...
### Freire: a educação como prática da liberdade

A educação bancária é projeção por excelência. O professor deposita sua visão de mundo sobre estudantes tratados como receptáculos vazios. O oprimido internaliza o modelo do opressor. Aderência ao opressor é o nome de Freire para o eu falso político. O sonho do oprimido é frequentemente tornar-se o opressor. Freire propõe o círculo de cultura. A consciência não chega de fora. Emerge do encontro entre experiências singulares que se reconhecem como expressões de uma mesma condição.

### Dussel: amar sem exigir conformidade

Antes do ego cogito há um ego conquiro. A filosofia da libertação parte do Outro como livre, como além do sistema da totalidade que o domina. Amar ao Outro sem que me ame (não mútua benevolência mas simples benevolência por ele, pelo Outro) é o ato ético que recusa a projeção.
...
Adams aponta a operação análoga no campo visual. A imagem periférica que não preenche o vazio, mas o circunscreve, gera desejo onde a indústria cultural do centro gera consumo. A diferença não está nos recursos, mas na topologia. A arte que confronta o vazio — sem brilho de produção, sem acabamento publicitário — é a que vibra.

A descolonização do desejo não se resolve por decisão, mas por processo que se torna possível quando há condições de encontro onde a captura possa ser percebida, nomeada e (eventualmente, sem garantia) transformada.

### Rivera Cusicanqui: o ch'ixi

O ch'ixi é uma cor produzida pela justaposição de pontos contrastantes. Algo que é e não é ao mesmo tempo. O nordestino, o negro, o indígena urbanizado não precisam escolher entre a modernidade e o arcaico, entre Marx e o Xangô, entre o digital e o coco. O ch'ixi é a coexistência de contrários em tensão produtiva sem fusão e sem hierarquia. A potência regional está exatamente na tensão irresolvida. Não na pureza de nenhuma das posições.

### Lélia Gonzalez, Abdias do Nascimento, Krenak

Lélia cunha a amefricanidade, a experiência compartilhada dos povos da diáspora africana em toda a América. O pretuguês (a marca da africanização do português falado no Brasil) não é desvio a corrigir, mas o sintoma com o qual o sujeito se identifica como ato político. Lélia coloca a mãe-preta no centro da formação cultural brasileira, a mulher negra que cumpriu a função materna enquanto seus próprios filhos eram vendidos.
...
### Gênero: o desejo projetado sobre o corpo da mulher

Há um eixo de projeção que o diagnóstico até aqui não nomeou com a precisão que exige. O desejo projetado sobre a mulher opera com qualidade distinta: ser mãe, ser cuidadora, ser disponível. A ambitio spinoziana que o pai projeta sobre o filho (capítulo II) encontra na projeção sobre a mulher uma variante que não é simétrica. O capitalismo precisa que esse desejo funcione para renovar a força de trabalho. A mulher que internaliza o imperativo do cuidado está reproduzindo as condições materiais do sistema sem remuneração e sem reconhecimento.

Silvia Federici (retomada no capítulo IX pelo trabalho reprodutivo) demonstrou que as caças às bruxas dos séculos XVI-XVII foram ataque sistemático ao poder que as mulheres detinham: controle reprodutivo, saber curandeiro, autonomia sobre o corpo. Esse ataque foi condição necessária para o capitalismo. A mulher como cuidadora "natural" é construção histórica rastreável, com data e endereço. A cozinha comunitária da Camada 7 (capítulo XVII), quando apresentada sem perguntar quem cozinha, quem limpa, quem cuida das crianças enquanto a assembleia acontece, reproduz o mecanismo que afirma combater. A relocalização do trabalho reprodutivo no comum só amplia potência se redistribui o cuidado entre os corpos que compõem a comunidade. Quando a cozinha comunitária libera tempo para homens se organizarem politicamente enquanto mulheres continuam cozinhando, o commons está funcionando como cercamento de gênero com outro nome.

Joan Tronto reformula o cuidado como prática política. Cuidar exige atenção (notar que o cuidado é necessário), responsabilidade (assumir que alguém precisa agir), competência (realizar o cuidado com eficácia) e responsividade (verificar se quem recebeu o cuidado foi atendido em seus termos). Esses quatro momentos descrevem o que a fenomenologia dos encontros transformadores (capítulo IX) exige como pré-condição material. A nomeação coletiva só acontece onde há atenção; o reconhecimento, onde há responsividade. Quando esses momentos são delegados sistematicamente a corpos femininos e racializados, o encontro transformador está sendo sustentado por trabalho invisível.

### Raça: o dispositivo que organiza o saber

Fanon e Gonzalez diagnosticaram a dimensão psíquica e cultural do racismo. Weheliye (retomado no capítulo X) corrige Foucault: a biopolítica subestima a raça. Denise Ferreira da Silva opera num nível mais profundo. A raça não é preconceito a ser superado nem identidade a ser afirmada. É o dispositivo onto-epistemológico pelo qual a modernidade organiza o saber. A separação entre sujeito e objeto, entre mente e corpo, entre cultura e natureza, sobre a qual toda a filosofia moderna se constrói, só funciona porque há corpos classificados como mais próximos da natureza, do corpo, do objeto. Esses corpos são racializados. A separabilidade é o código racial da modernidade.

"Diferença sem separabilidade" é a formulação que Ferreira da Silva propõe como alternativa. Se tudo é modo de uma única substância (Spinoza, Ética I), a separabilidade que funda o sujeito moderno desmorona. O spinozismo radicalizado por Ferreira da Silva dissolve a base sobre a qual o sujeito colonial se constituiu como separado do colonizado. A ética do desejo opera com categorias europeias (Spinoza, Lacan, Foucault) aplicadas desde a periferia. Ferreira da Silva obriga a perguntar: essas categorias carregam em si a separabilidade que pretendem dissolver? A resposta exige vigilância contínua, que é outra formulação do Princípio VIII (autocorreção permanente).

Sylvia Wynter acrescenta a dimensão que falta ao diagnóstico. A categoria "Homem" que a modernidade universalizou, o sujeito racional, autônomo, transparente a si mesmo, é invenção europeia que se apresenta como humano genérico. Toda pessoa que não cabe nessa categoria (o negro, a mulher, o indígena, o louco, o deficiente) é classificada como sub-humana por definição. O racismo não é desvio do projeto iluminista. É condição para que o projeto funcione: a universalidade do Homem se sustenta pela exclusão silenciosa de quem não cabe nela.

A branquitude permanece como posição não-nomeada que estrutura o campo. Nomear a branquitude como posição, e não como ausência de raça, é condição para que o Princípio II (anti-colonial) opere com rigor. O sujeito branco que "não tem raça" ocupa a posição do sujeito universal de Wynter: o ponto zero a partir do qual tudo é medido sem que o próprio ponto seja medido.

### Marronage: a tecnologia política da liana

Dénètem Touam Bona propõe a marronage como tecnologia política permanente, ampliando o quilombismo de Nascimento para a rede transatlântica. A metáfora central é a liana: planta que não confronta a árvore frontalmente (como faria a revolução clássica), não se submete a ela (como faria o reformismo), compõe com a estrutura existente para transformá-la por dentro. A liana usa o que encontra como suporte, sem ser capturada pelo que a sustenta.

O refúgio do marron não é segurança. É criação desde a insegurança. O quilombo não era lugar seguro; era lugar onde se inventava vida fora da lógica da plantation, sob risco permanente. Essa formulação corrige uma tendência do argumento: a Comunidade-Nação em sete camadas pode ser lida como projeto de segurança, como se as camadas, uma vez construídas, garantissem proteção. A marronage lembra que a construção acontece sempre sob risco, sempre provisória, sempre pronta para se refazer quando a repressão chega. O MST sabe disso: cada acampamento pode ser queimado. A potência não está na permanência, mas na capacidade de reconstruir.

<mermaid src="cap-VII" description="O olhar desde a periferia: Freire, Dussel, Fanon, Rolnik, Cusicanqui, Lélia Gonzalez, Krenak. Gênero (Federici, Tronto), raça como dispositivo ontológico (Ferreira da Silva, Wynter), marronage (Touam Bona). A colonialidade do saber é inseparável do saber periférico que a confronta."></mermaid>


## VIII. Imperialismo: o desejo projetado em escala geopolítica

Se o amor projetado é a célula primordial do câncer social nas relações interpessoais, o imperialismo é a metástase final. O desejo projetado operando em escala civilizacional, com exércitos, bancos e tratados internacionais como instrumentos.
...
Para Mbembe, a soberania em sua expressão mais radical consiste no poder de decidir quem pode viver e quem deve morrer. Quando o fator de desconto δ de uma população aproxima-se de zero (quando sobreviver hoje é o único problema real), toda lógica da cooperação colapsa. O Brasil produz necropolítica com eficiência industrial. Chacinas nas periferias, encarceramento em massa de jovens negros, letalidade policial concentrada geograficamente.

O δ não resulta apenas de violência direta, mas de engenharia política. O ajuste fiscal imposto pelo FMI como condicionalidade de empréstimos reduz o horizonte temporal de uma população inteira.

Quando o orçamento para saúde é contingenciado, quando as universidades públicas veem seus recursos diminuir ano após ano, quando não há garantia que o SUS terá medicamentos próximo mês, o corpo politicamente colapsa seu próprio horizonte futuro.

O pobre que precisa decidir se come hoje ou investe em educação está sob controle δ. O banco central que prioriza meta de inflação sobre pleno emprego está reduzindo δ das trabalhadoras.

Privatizar a água, a energia, a terra não são apenas políticas econômicas. São tecnologias de colapso do futuro. Quando os recursos básicos para viver não são garantidos a médio prazo, o sujeito não consegue cooperar. A cooperação exige que eu confie que amanhã meu parceiro cooperativo ainda existirá e honrará nossos acordos. O necropoder que reduz δ não precisa matar diretamente. Mata por sufocamento do futuro.

Mas a necropolítica não age sozinha. Na periferia brasileira, o sujeito está sob violência necropolítica e violência neuronal simultaneamente. Essa sobreposição é o que nem Mbembe nem Han, isoladamente, conseguem pensar. O jovem negro da Zona Norte do Recife que dirige Uber doze horas por dia está sob violência clássica do Estado, a polícia que para, a blitz que humilha, a bala que mata. E sob autoexploração no sentido de Han, o sujeito de desempenho que se cobra, que toma ritalina para aguentar, que se sente culpado quando descansa.

A superexploração de Marini (o salário que não cobre a reprodução biológica) é a camada estrutural que sustenta as duas. O corpo precisa se autoexplorar porque é superexplorado e é superexplorado dentro de um regime necropolítico que o trata como descartável. Três camadas, um corpo. O diagnóstico que vem desde o centro (seja a biopolítica de Foucault, a necropolítica de Mbembe ou a psicopolítica de Han) captura uma camada de cada vez. A periferia exige articulação simultânea.

A resistência ao necropoder começa pela criação de novas temporalidades. Santner formula a pergunta que a necropolítica inverte. Como converter o excesso biopolítico, a vida-morta, o *undeadness* que o regime instala, em "bênçãos de mais vida"? A resposta não está num programa, mas numa arquitetura de encontro, o espaço onde o que pesa pode ser nomeado com outros e, nomeado, se transforma. O quilombo, a ocupação do MST, a comunidade zapatista reconstituem o δ, reabrem o futuro onde o poder imperial o havia fechado. A mística do MST, que frequentemente é ridicularizada como superstição ou compensação psicológica, é na verdade tecnologia deliberada de elevação do δ.

Quando o movimento celebra Palmares, Chico Mendes, as lutas de Canudos, não está em nostalgia. Está recriando continuamente a prova de que o futuro é possível porque foi possível antes. O quilombo que durou um século sem ser capturado pelo Estado é a evidência materializada de que uma temporalidade diferente existe e pode ser construída.

Contra a redução do δ imposta pela dívida contrarrevolucionária (o sistema de crédito que mantém baixo o horizonte temporal dos pobres), o movimento monta um sistema de dívida revolucionária, a dívida para com os ancestrais que lutaram, que obriga a pensar em futuro.

A mística é a operação permanente de abertura do horizonte que o capital tenta fechar. Não é coincidência que a mística do MST cuide deliberadamente da mem��ria de lutas passadas (o passado como prova) e de visão de futuro (as bandeiras, os acampamentos como atos de ocupação do tempo). O que Han chama de "transitoriedade radical", a perda moderna de toda promessa de duração, é na periferia condição material imposta antes de ser patologia subjetiva. A reconstituição do δ não se confunde com exercício contemplativo. É luta de classes pelo tempo.

### Benjamin: a destruição da experiência e a captura digital

O imperialismo do século XXI não age apenas pelos mecanismos que Lênin, Luxemburg e Marini descreveram. Age pela captura do tempo, da atenção e da narrativa em escala algorítmica. Walter Benjamin diagnosticou essa captura antes que ela existisse em forma digital.

Em "O Narrador" (1936), Benjamin identificou o colapso da Erfahrung, a experiência transmitida de geração a geração, oral, lenta, enraizada na comunidade que partilha trabalho e história. A informação jornalística a substituiu: pontual, consumível, perecível no instante seguinte à leitura. O que a imprensa começou, a plataforma digital consumou. O feed é informação pura, sem espessura temporal, sem narrador que carregue autoridade de experiência vivida. A Erlebnis, vivência fragmentada pelo choque, substituiu a Erfahrung como modo dominante de relação com o mundo.

A consequência para a ética do desejo é precisa. A nomeação coletiva (primeiro movimento da fenomenologia dos encontros, capítulo IX) pressupõe capacidade narrativa: alguém conta a alguém o que viveu, e o outro reconhece. Sem narração, não há nomeação. Sem nomeação, o sofrimento permanece privado. A destruição da capacidade narrativa pela plataforma não é efeito colateral. É condição de funcionamento do capitalismo de vigilância: sujeitos que não narram coletivamente não se organizam.

Benjamin diagnosticou também a fantasmagoria, o modo como as mercadorias ocultam as relações sociais que as produziram. Na era digital, a fantasmagoria atinge seu paroxismo. A Internet das Coisas produz objetos que "falam", que emitem dados, que interpelam o sujeito. A geladeira conectada, o relógio que monitora batimentos cardíacos, o assistente de voz que escuta permanentemente. Esses objetos não são mercadorias passivas. São agentes de extração que operam dentro da casa, no corpo, no sono. A fantasmagoria de Benjamin era a aparência mágica da mercadoria na vitrine. A fantasmagoria digital é a mercadoria que se instalou dentro do sujeito e se apresenta como serviço.

Nick Couldry e Ulises Mejias nomearam o mecanismo como colonialismo de dados. A relação entre plataformas do Norte e populações do Sul reproduz a estrutura colonial: países-extratores e populações-fornecedoras de matéria-prima. Os dados são a nova exterioridade não-capitalista que Rosa Luxemburg descreveu. Quando o exterior geográfico se esgotou, o capital encontrou outro exterior: a vida cotidiana, os afetos, os padrões de sono, as conversas. A dupla captura é o que distingue a plataforma do imperialismo clássico: extração econômica do afeto (monetização dos dados comportamentais) e uso dos mesmos dados para repressão preventiva (perfilamento policial, modulação eleitoral, censura algorítmica).

Payal Arora inverte a perspectiva. A lan-house, o celular compartilhado, o WhatsApp comunitário são cosmotécnicas populares. Modos de usar a tecnologia que o Vale do Silício não previu e não consegue tornar legíveis. A periferia não é apenas vítima da captura digital. Produz usos que escapam ao modelo de extração. O grupo de WhatsApp que organiza a cozinha comunitária opera dentro da plataforma e contra ela: usa a infraestrutura do extrator para fins que o extrator não monetiza.

Benjamin encerrou o ensaio sobre a reprodutibilidade técnica com um alerta: o fascismo estetiza a política, permitindo que as massas se expressem sem alterar as relações de propriedade. As redes sociais atualizaram o mecanismo. A política-performance que simula transformação dentro da lógica da plataforma, o compartilhamento indignado, a denúncia viral, o cancelamento que não altera estrutura, tudo isso é expressão sem alteração das relações de propriedade. O acting out digital se distingue do acting out clássico (capítulo IV) porque opera inteiramente dentro do circuito de captura: a energia despendida na indignação alimenta o algoritmo que gera receita para a plataforma que a tornou possível. Distinguir acting out digital de participação genuína é tarefa que a federação transversal (capítulo XXI) precisa enfrentar com protocolos específicos.
...
<mermaid src="cap-VIII" description="Imperialismo: a teoria da dependência (Brasil como formação periférica). Lênin, Luxemburg, Marini. O desejo projetado em escala geopolítica. Necropolítica: quem pode morrer?"></mermaid>


## IX. A ética do desejo como condições de possibilidade
...
Mas onde o mesmo Estado prescreveu — quando decidiu quantos filhos cada família deveria ter — o custo foi irreversível. A política do filho único chinesa (1980–2015) é a prescrição mais cara da história moderna. A população começou a encolher em 2022 e a crise demográfica é estrutural. A lição é precisa. Quando cria condições, funciona. Quando prescreve comportamento íntimo, cobra-se com juros que nenhuma correção posterior paga.

O capítulo IV fundamentou psicanaliticamente essa escolha via das Ding: o desejo se organiza em torno de um vazio que nenhuma prescrição alcança. Georges Bataille acrescenta a dimensão econômica do mesmo problema. A dépense, o gasto improdutivo (festa, ritual, arte, erotismo, sacrifício), é o que toda comunidade precisa gastar sem retorno calculável. A "parte maldita" da economia é o excedente que a composição gera e que o cálculo utilitário não absorve. Sem vias para esse excedente, ele retorna como cisma, narcisismo organizativo ou acting out. Os commons que duram reservam espaço para dépense coletiva. A mística do MST, a festa junina do assentamento, o forró depois da assembleia são vias para o excedente. O capitalismo absorve esse gasto e o converte em mercadoria, indústria do entretenimento, turismo de experiência, festival corporativo.

O critério composicional spinoziano ("amplia ou diminui a potência de agir?") opera como primeiro registro ético. A dépense e a estrutura dissipativa do conatus (capítulo XIII) exigem dois registros complementares. A pergunta tripla que orienta toda decisão: (1) Amplia ou diminui a potência de agir? (2) E o que faz com o que sobra? (3) Expande ou contrai o espaço de possibilidades futuras? A terceira pergunta, derivada de Kauffman (capítulo XIII), já está implícita no exemplo da política do filho único: ampliou potência de agir no curto prazo (controle populacional) e contraiu o espaço de possibilidades futuras de modo irreversível. As três perguntas ganham formalização no capítulo XIII como dimensões de um espaço político tridimensional (relação com o real, relação entre corpos, arquitetura do fluxo) onde o δ, o horizonte temporal que torna a cooperação possível, se torna variável construível em vez de parâmetro dado.

### As noções comuns e a assimetria colonial
...
O que as experiências mais duradouras parecem ter em comum pode ser descrito em quatro movimentos. (1) Nomeação coletiva, uma situação que era sofrida privatadamente ganha nome partilhado. (2) Reconhecimento, o sofrimento é compartilhado, o que transforma a culpa individual em análise coletiva. (3) Identificação de causalidade, a conexão entre o singular e o estrutural que transforma lamento em compreensão. (4) Ação que emerge da compreensão, sem precisar ser imposta por linha partidária.
...
Eric Santner oferece uma distinção que importa para a forma como a ação emergente opera. A tradição žižekiana propõe a travessia do fantasma como ato revolucionário: destruir a fantasia que sustenta a realidade simbólica, submeter-se à destituição subjetiva. Santner propõe conversão: metabolizar o excesso biopolítico, a "vida criatural" que o capítulo I identificou no menino do recreio, em "bênçãos de mais vida" pela via da responsividade ética ao vizinho. A diferença importa porque a travessia presume ato heroico, e o ato heroico pode ser acting out disfarçado de radicalidade. A conversão opera dentro da incompletude. Aceita que a comunidade, a organização, o sujeito nunca estarão "prontos" e que a transformação acontece no gesto cotidiano de responder ao que o outro corpo pede, sem esperar o momento perfeito para a ruptura total.

A nomeação coletiva (primeiro movimento) depende de uma capacidade que Benjamin diagnosticou em declínio irreversível: a capacidade de narrar. Em "O Narrador" (1936), Benjamin distingue informação de narrativa. A informação é verificável, perecível, consome-se no instante da leitura. A narrativa carrega sabedoria, transmite-se de corpo a corpo, vive porque quem ouve a retransmite. O feed algorítmico é informação pura. A cozinha comunitária onde uma mulher conta para a outra como perdeu o emprego é narrativa. A capacidade narrativa é pré-condição material dos encontros transformadores, tão material quanto o espaço físico ou o tempo livre. A plataforma digital que substitui narração por notificação destrói essa pré-condição. Espaços de narração protegida, lugares onde se conta e se ouve sem urgência de resposta, sem métrica de engajamento, sem feed que interrompe, são infraestrutura do primeiro movimento tanto quanto a cozinha ou a praça.

Benjamin nomeou também o Jetztzeit, o tempo-agora: o instante em que o passado é arrancado do contínuo da história e se torna atual, carregado de possibilidade. A mística do MST (capítulo VIII) é operação de Jetztzeit. Quando o movimento celebra Palmares e Canudos, não está narrando o passado cronologicamente. Está produzindo um agora em que o passado demonstra que o futuro é possível. O Jetztzeit interrompe o tempo homogêneo do progresso, que é o tempo do capital, e instaura outra temporalidade onde a ação emerge.

### As condições materiais dos quatro movimentos
...
### Esperança como conatus e composição desde corpos não-normativos

Paulo Freire, no trabalho tardio (_Pedagogia da Esperança_, 1992), formula o que a ética do desejo precisa como categoria operativa: a esperança é ontológica, constitutiva do ser humano, conatus projetado no tempo. Sem ela, o conatus se fecha no presente e se reduz a sobrevivência. A esperança que Freire descreve não é otimismo. Otimismo é expectativa passiva de que as coisas melhorem. Esperança é ação que antecipa, na prática, a transformação que ainda não existe. A mística do MST é esperança no sentido freireano: atua como se o futuro já estivesse começando.

Freire propõe também o que chamou de "pós-modernidade progressista": aceitar a crítica pós-moderna à metanarrativa totalizante (a revolução como destino inevitável) sem abrir mão da transformação coletiva. Recusar o programa que prescreve o futuro e recusar o cinismo que abandona qualquer futuro. A posição epistemológica que a ética do desejo ocupa desde o primeiro capítulo tem agora nome: nem modernismo prescritivo, nem pós-modernismo resignado. Pós-modernidade progressista.

Alison Kafer, em _Feminist, Queer, Crip_, coloca uma pergunta que o framework ainda não enfrentou: que futuros imaginamos e que corpos esses futuros pressupõem? A Comunidade-Nação em sete camadas, as assembleias, as cozinhas comunitárias, os mutirões pressupõem corpos capazes de se deslocar, ouvir, falar, permanecer de pé, processar informação no ritmo da reunião. Corpos com deficiência, corpos neurodivergentes, corpos cronicamente doentes habitam essas estruturas em condições que o design ignora quando não pergunta por eles.

Mia Mingus nomeia a intimidade de acesso: o momento em que outra pessoa reconhece suas necessidades sem que você precise explicar. Quando alguém ajusta a cadeira sem ser pedido, quando a reunião muda de horário porque reconhece que o corpo do outro tem ritmo diferente. A intimidade de acesso é composição spinoziana em ato. Difere da acomodação burocrática (a rampa obrigatória, o intérprete contratado) porque opera pela relação, não pela norma. O Princípio V (Conatus coletivo) amplia potência quando inclui a dimensão dos corpos que precisam de composição específica para participar. A potência coletiva que exclui corpos não-normativos do encontro diminui sua própria base.

<mermaid src="cap-IX" description="A ética do desejo como condições de possibilidade: 4 movimentos, acting out versus ação emergente. Noções comuns e assimetria colonial. Fenomenologia dos encontros transformadores."></mermaid>
...
Quando Butler demonstra que a identidade é performativamente constituída pelas próprias expressões que supostamente são seus resultados, abre caminho para uma subversão possível através da repetição com deslocamento, não pela recusa do performativo, mas pela sua reapropriação. O desejo projetado atua como um performativo forçado, nomeando e constituindo o Outro de acordo com o enquadramento do projetor. A contraperformatividade reapropria o gesto e desloca o enquadramento.
...
<mermaid src="cap-XI" description="O transfugismo como tecnologia do eu (Foucault, Bourdieu, Eribon). Rancière, Glissant, hooks, Gramsci. O intelectual orgânico como sujeito que foge e articula hegemonia popular."></mermaid>


## XII. A arquitetura como resposta

### Do diagnóstico ao design institucional
...
**Camada 4, A Mesorregião / O Polo Produtivo.** Louis precisava de trabalho que o dignificasse, não a lógica do assalariamento onde sua força é comprada e seu corpo é resto descartável. A cooperativa na escala da mesorregião organiza produção onde o trabalho é comum, onde quem trabalha decide. Nega o mecanismo econômico que gerava precariedade estrutural.

**Camada 3, O Estado Federativo.** Louis precisava que o poder não fosse concentrado em poucos que o julgassem. A federação redesenhada distribui o medo de forma que nenhum bloco o monopolize, o Estado spinoziano que gera condições sem prescrever resultados. Nega a hipertrofia do poder que penalizava a dissidência.

**Camada 2, A Unidade Territorial Viva.** Louis precisava estar enraizado, não a raiz que prende, mas a raiz que alimenta. Produtor e consumidor da mesma região, conhecendo a cadeia de trabalho que o mantém vivo. Nega a abstração das cadeias capitalistas que tornavam invisível o preço cobrado do corpo negro.

**Camada 1, O País.** Louis precisava de soberania, a proteção de que nenhuma potência externa pudesse vir lhe arrancar o que tivesse conquistado. A soberania garante que a revolução não será invadida. Nega o imperialismo que mantinha fechado o horizonte futuro.

### O critério spinoziano atravessa todas as camadas

Nenhuma camada existe para cumprir um mandato externo. Cada uma existe para ampliar a potência de agir dos corpos que a compõem. Esse critério único de avaliação se resume a uma pergunta. Amplia ou diminui a potência de agir?

A Rua é boa quando transforma o encontro em invenção coletiva. A Cidade é boa quando a assembleia gera decisões que servem a quem as sofre. O Estado é bom quando redistribui poder em vez de concentrá-lo.
...
A arquitetura não funciona como hierarquia onde Brasília comanda o bairro, mas como fractal, a mesma lógica relacional em cada escala. A autonomia compositiva (cada camada preserva sua consistência própria) atua na Rua como atua no País. A articulação federativa (máxima comunicação entre níveis sem hierarquia que sufoca) atravessa todos os níveis. O critério spinoziano (potência de agir) vale quando uma avó cuida de crianças e quando uma nação negocia com o capital transnacional.

Essa é a estrutura que permite que a potência brote de baixo (da Rua, do encontro) sem cair no espontaneísmo (porque cada camada articula a potência das camadas que a compõem). E sem cair no leninismo (porque nenhuma camada superior prescreve o que as inferiores devem fazer).

### Potência vs. Potestas

Spinoza distingue na Ética entre _potentia_ (poder constituinte, a capacidade de agir coletivamente) e _potestas_ (poder constituído, as instituições que emergem quando potentia encontra forma). O Estado-Nação convencional funciona como arquitetura de potestas, que prescreve resultados, guia comportamentos e domestica a potência constituinte. A Comunidade-Nação funciona como arquitetura de potência, que gera condições para que a potência constituinte encontre suas formas próprias de expressão.

Quando a Camada 1 captura a potência constituinte em vez de protegê-la, ela deixou de ser a condição de possibilidade das seis camadas abaixo e se tornou o inimigo delas. O design democrático spinoziano minimiza essa captura por meio de separação de poderes real (não formal), mecanismos de revogação de mandato, transparência fiscal radical e participação direta nas decisões estratégicas.

### A ponte para a matemática

Tudo isso permanece no plano da afirmação, ainda descrição de como seria, não demonstração de que é possível. O capítulo seguinte responde a pergunta que a arquitetura deixa suspensa. _Por que_ essa estrutura em sete camadas permite que a potência coletiva dure? A resposta vem da teoria dos jogos, da termodinâmica de sistemas dissipativos, e de um espaço tridimensional que permite plotar qualquer movimento político em relação à potência coletiva que constrói ou destrói. A matemática prova o que a filosofia diagnosticou. E depois, só depois, vem o desenho territorial do Brasil como o lugar onde essa arquitetura pode ser construída.

<mermaid src="cap-XII" description="A arquitetura como resposta ao diagnóstico: 7 camadas do Estado Nação à Pessoa. Cada camada responde a uma dimensão da contradição. O critério spinoziano fractal atravessa todas."></mermaid>


## XIII. A matemática da cooperação e da assimetria

### O Dilema do Prisioneiro como anatomia da desconfiança

A teoria dos jogos fornece a prova matemática da tese central. A estratégia dominante para quem age por puro autointeresse é desertar. A deserção mútua engendra o pior resultado coletivo. O Equilíbrio de Nash da deserção mútua permanece Pareto-subótimo. Todos perdem mais do que perderiam se cooperassem.

Nos torneios de Axelrod, o Tit-for-Tat venceu todas as rodadas por ser amável (nunca deserta primeiro), retaliatório (pune a deserção), indulgente (retorna à cooperação) e claro (seu comportamento é previsível). A injunção matemática contra a inveja dispensa moralismo. Não importa que o outro ganhe mais do que eu, desde que eu ganhe mais cooperando do que desertando.
...
O design institucional não resolve a necropolítica, mas cria as condições para que corpos sob δ estruturalmente baixo consigam erguer juntos um horizonte comum.

### O Valor de Shapley: matemática da distribuição justa

Ostrom descreve como manter a cooperação, mas não como distribuir equitativamente os ganhos quando membros diferentes contribuem de forma desigual. Essa é a lacuna que o Valor de Shapley preenche. A ferramenta, desenvolvida por Lloyd Shapley para a teoria dos jogos, calcula a contribuição marginal de cada jogador aos ganhos coletivos. Longe de ser uma média simples que ignora quem mais contribuiu, o Valor de Shapley atribui a cada membro uma fração do ganho proporcional ao valor que sua presença agregou à coalizão.

Na prática cooperativa, isso resolve um problema real. Quando a cooperativa gera R$ 100 de riqueza com participação desigual, como dividir? Quem trabalhou mais? Quem arrastou quem? O Valor de Shapley oferece um critério matemático que não é nem marxista puro (a cada um conforme o trabalho) nem capitalista (a cada um conforme a propriedade), e sim a cada um conforme a contribuição real que sua presença adicionou ao coletivo. Isso reduz o espaço das disputas sobre "justiça" e o amplia para o que realmente importa. Agora os membros podem discutir não "quanto devo ganhar?" (que é resposta matemática) mas "como queremos viver juntos com base nessa distribuição justa?"

### Plataformas cooperativas e a propriedade dos dados

A assimetria temporal δ não atravessa apenas populações nacionais. Atravessa também o nível dos trabalhadores. O Uber driver que dirige doze horas por dia tem δ baixo (precisa de renda hoje) e compete com a empresa Uber que tem δ altíssimo (pode esperar anos para lucrar). A propriedade dos dados designa a versão contemporânea da propriedade dos meios de produção. Quando os dados da motorista, seu histórico de trajetos, suas preferências e seu padrão de comportamento pertencem à Uber, a assimetria é total.
...
### Capacidades como métrica do critério composicional

Amartya Sen propõe que o desenvolvimento seja medido pela expansão de capacidades: o que as pessoas conseguem efetivamente ser e fazer. Capacidade no sentido de Sen é estruturalmente homóloga à potentia de Spinoza. A diferença é que Sen a torna mensurável. Martha Nussbaum tentou fixar uma lista universal de dez capacidades fundamentais (vida, saúde corporal, integridade física, sentidos e imaginação, emoções, razão prática, afiliação, relação com outras espécies, lazer, controle sobre o ambiente). A lista é coerente, mas prescreve. Sen recusou a lista fixa. Quais capacidades importam deve ser deliberado por quem as vive. A recusa de Sen opera no discurso do analista. A prescrição de Nussbaum opera no discurso do mestre. O Pacto segue Sen.

Sabina Alkire e James Foster desenvolveram o Índice de Pobreza Multidimensional (IPM), que mede privação de capacidades em múltiplas dimensões simultaneamente. A ferramenta transforma "amplia ou diminui a potência de agir?" de pergunta retórica em métrica auditável. O IPM não exige lista universal. Cada contexto configura quais dimensões são relevantes. Uma comunidade quilombola no Recôncavo baiano pode priorizar terra, segurança alimentar e reconhecimento cultural. Uma comunidade urbana no Ibura pode priorizar saneamento, segurança e tempo livre. A métrica se adapta porque o framework é configural, não prescritivo. A Camada 6 (bairro) pode usar o IPM como ferramenta de legibilidade interna: medir a própria potência sem depender de indicadores definidos por quem está fora.

### Design de mecanismos: projetar a cooperação

A teoria dos jogos clássica descreve por que a cooperação falha. O design de mecanismos inverte: projeta regras que a produzem. Eric Maskin demonstrou que é possível construir mecanismos onde a estratégia dominante de cada agente coincide com o resultado socialmente desejável. Não por moralismo, mas por arquitetura.

Glen Weyl e Audrey Tang, em _Plurality_ (2024, publicado em CC0), propõem a votação quadrática como operacionalização do Princípio III (assimetria como dado). Na votação convencional, cada pessoa tem um voto por questão. Na votação quadrática, cada pessoa distribui créditos entre as questões que lhe importam. O custo cresce quadraticamente: um voto custa 1 crédito, dois votos na mesma questão custam 4, três custam 9. Quem se importa pouco com uma questão gasta pouco. Quem se importa muito gasta mais, mas com custo crescente. A intensidade de preferência se expressa matematicamente. O mecanismo compensa a assimetria de interesse que a votação igualitária ignora: quando a mulher negra periférica é a mais afetada por uma decisão sobre creches, seu voto pesa mais nessa questão específica, sem que ela precise convencer ninguém de que seu interesse é legítimo. O Princípio III se torna protocolo.

A Ostrom tardia acrescenta: diversidade institucional é tão vital quanto biodiversidade. Comunidades que adotam uma única forma de governança são frágeis. A governança policêntrica (múltiplos centros de decisão sobrepostos, em escalas diferentes, sem hierarquia fixa entre eles) é a forma institucional que a complexidade exige. As sete camadas da Comunidade-Nação são governança policêntrica: cada camada decide sobre o que a afeta, coordena com as outras sem se subordinar a nenhuma.

### Brutalismo e o devir-negro do mundo

Achille Mbembe, em _Brutalisme_ (2020), atualiza o diagnóstico de _Necropolítica_. A necropolítica diz quem morre. O brutalismo diz como a vida que "sobrevive" é reduzida a matéria bruta, computável, extraível. O δ que a teoria dos jogos mede é sintoma dessa redução: quando o horizonte temporal colapsa, o corpo se torna dado processável, não sujeito que coopera.

O conceito de devir-negro do mundo universaliza o diagnóstico sem apagar diferenças. A condição que a escravidão produziu para corpos negros (fungibilidade, vida dispensável, exclusão da humanidade jurídica) se expande. Na era do algoritmo, todo corpo conectado se torna parcialmente fungível: perfil comportamental, escore de crédito, dado processado. O devir-artificial, a redução do humano a padrão de dados, é o que Rolnik chamou de cafetinagem atualizada para a escala digital. Felwine Sarr, em _Afrotopia_, propõe a resposta que complementa o diagnóstico: a potência não se projeta no futuro como plano. Encontra-se no presente como prática que já acontece. A economia relacional de Sarr, onde o que sustenta a troca são relações e não transações, é a forma econômica do que a Comunidade-Nação propõe nas Camadas 6 e 7.

### O espaço tridimensional da potência coletiva

O Banco Palmas funciona há mais de duas décadas. Está enraizado no Conjunto Palmeiras, produz cooperativamente, distribui renda, e as decisões são tomadas em assembleia onde cada família tem voto. O bolsonarismo, derrotado eleitoralmente, persiste como regime molecular de afetos. Governa nos grupos de família, nos cultos neopentecostais, nas abordagens policiais. Os dois existem no Brasil de 2026. A teoria dos jogos, a filosofia política e a economia não conseguem, isoladamente, explicar por que um compõe e o outro decompõe. A razão é que o diagnóstico precisa de três dimensões simultâneas.

**Dimensão 1: relação com o real.** O polo positivo é a práxis, ação consciente baseada em diagnóstico material. O MST que mapeia a estrutura fundiária e ocupa terra age a partir da compreensão das condições reais. O polo negativo é o espetáculo, performance que simula transformação sem alterar relações de propriedade. O compartilhamento viral de indignação que alimenta o algoritmo sem mudar estrutura opera no espetáculo. Benjamin (capítulo VIII) diagnosticou a passagem da Erfahrung (experiência transmitida, enraizada) à Erlebnis (vivência-choque, fragmentária). A plataforma digital consuma essa passagem. O eixo D1 mede onde uma prática se situa entre esses polos.

**Dimensão 2: relação entre corpos.** O polo positivo é a composição spinozana, corpos que ampliam mutuamente a potência de agir. A cozinha comunitária que alimenta, cria vínculo e libera tempo para organização política compõe. O polo negativo é a extração, quando a potência de uns alimenta a acumulação de outros. O Uber que extrai dados, tempo e saúde do motorista periférico decompõe. O eixo D2 vai além da dicotomia socialismo/liberalismo. Há formas de socialismo que extraem (o Estado que prescreve e captura) e formas de economia de mercado que compõem (a cooperativa que opera em mercado sem acumular para fora). O critério é composicional, e o vocabulário adequado é o de Spinoza.

**Dimensão 3: arquitetura do fluxo.** O polo positivo é a facilitação, hierarquia que distribui acesso ao fluxo de recursos, decisões e informação. O SUS quando funciona facilita: o recurso federal chega à UBS do bairro. O polo negativo é a captura, hierarquia que retém para si o que deveria passar. A secretaria estadual que absorve o orçamento sem repassar captura. A lei construtal de Bejan (seção anterior) demonstra que hierarquia emerge em qualquer sistema de fluxo por necessidade física. A pergunta não é se haverá hierarquia, mas a serviço de quem o fluxo opera.

**As três dimensões são independentes.** Cuba pontua alta em composição (D2+: saúde universal, biotecnologia soberana) e alta em práxis (D1+: diagnóstico material preciso, planejamento real), mas concentra poder político sem canal aberto de dissidência (D3 misto). O Banco Palmas pontua alto nas três (D1+, D2+, D3+), mas na escala da Camada 7. O bolsonarismo pontua baixo nas três (D1-: espetáculo; D2-: extração; D3-: captura), mas simula composição na escala do grupo de família e do culto neopentecostal. A Big Tech progressista pontua D1- (espetáculo sofisticado), D2- (extração disfarçada de serviço) e D3- (facilitação aparente, captura real). Um partido leninista clássico pode pontuar D1+ (práxis enraizada) e D2+ (solidariedade de classe) mas D3- (centralismo que captura potência da base). A independência das dimensões é o que permite que o diagnóstico seja preciso em vez de moral.

### O δ como função construível

Nos capítulos anteriores, o δ (fator de desconto) apareceu como medida do horizonte temporal: quanto o corpo valoriza o futuro em relação ao presente. A teoria dos jogos clássica trata δ como parâmetro dado. A ética do desejo o trata como variável produzida por condições políticas.

As três dimensões afetam δ por mecanismos distintos. D1 afeta pela via epistêmica: quem compreende por que sofre prevê consequências, e prever consequências é projetar-se no tempo. A práxis freireana (ler o mundo para agir sobre ele) amplia δ porque a compreensão causal estende o horizonte do previsível. O espetáculo reduz δ porque treina o corpo para reagir a estímulos sem construir narrativa causal. D2 afeta pela via material: quem não sabe se come amanhã não planeja depois de amanhã. A cooperativa que distribui renda gera previsibilidade. A extração impõe precariedade que colapsa o futuro. D3 afeta pela via institucional: quem participa das decisões sobre o próprio futuro tem razão para investir nele. Quem é governado sem ser ouvido aprende que o futuro será decidido por outros.

O δ de cada corpo é função dessas três dimensões: δᵢ = g(D1ᵢ, D2ᵢ, D3ᵢ). A função g é crescente em cada argumento (mais práxis, mais composição, mais facilitação produzem horizonte temporal mais longo) e carrega três propriedades.

A primeira propriedade é o limiar material. Existe um patamar mínimo de D2 abaixo do qual δ colapsa independentemente de D1 e D3. A superexploração de Marini (capítulo VIII) formaliza isso: quando o salário não cobre a reprodução biológica, o corpo não pode planejar além do próximo dia. A fome derrota a democracia. O design institucional mais sofisticado é inútil sem piso material. A Camada 7 (cozinha solidária, cuidado coletivo) existe para garantir esse piso.

A segunda propriedade é o δ fictício. O fascismo eleva o horizonte temporal aparente sem alterar condições materiais. A promessa de grandeza nacional, o mito do líder salvador, o significante-mestre que organiza esperança sem fundamento material produzem um δ que sustenta mobilização de curto prazo. O bolsonarismo opera assim: injeta futuro ("o Brasil vai ser grande") sem mudar D2 nem D3. O δ fictício é instável. Depende da renovação permanente do espetáculo. Quando o significante-mestre falha (o mito é preso, a economia quebra), o δ colapsa de uma vez. A diferença entre δ real (construído por D1, D2, D3) e δ fictício (sustentado por intensidade do significante-mestre) é testável: o primeiro resiste a choques porque tem base material. O segundo desmorona ao primeiro choque.

A terceira propriedade é a não-linearidade. A relação entre dimensões e δ não é proporcional. Existem limiares críticos onde pequenas mudanças produzem saltos (criticalidade auto-organizada, Prigogine/Kauffman). O Banco Palmas antes e depois da moeda social ocupa pontos próximos em D2 mas radicalmente distantes em δ: a moeda social atravessa um limiar de confiança que transforma cooperação esporádica em cooperação sustentada. A ocupação de terra pelo MST é outro limiar: antes da ocupação, famílias dispersas com δ baixo. Depois, comunidade com futuro construível.

A potência coletiva de um grupo não é a soma das potências individuais. É propriedade emergente da composição. Cada encontro que amplia potência mútua (alegria spinozana) adiciona um termo positivo. Cada encontro que decompõe subtrai. A Comunidade-Nação em sete camadas maximiza os termos positivos ao criar condições materiais e institucionais para que os encontros aconteçam (Camada 7), sejam sustentados (Camada 6), escalem (Camada 5) e se articulem federativamente (Camadas 4-1).

O problema de maximizar a potência coletiva não admite solução analítica. Três razões convergem. Das Ding (capítulo IV): o vazio no centro da composição impede que a função-objetivo seja completamente especificada. "Potência de agir" resiste à formalização completa, pelo mesmo motivo que Russell (capítulo XX) demonstrou para o alinhamento de IA. A contingência de Kauffman: o possível adjacente é imprevisível. A decisão que maximiza potência hoje pode contrair o espaço de possibilidades amanhã. A reflexividade de Rouvroy (capítulo V): o sistema que mede a si mesmo altera a si mesmo ao medir. A comunidade que monitora D1, D2, D3 e age sobre os resultados transforma o campo que está medindo.

### O princípio de maximização: experimentar, acumular, proteger

Se a otimização analítica não fecha, o que fecha é o ciclo iterativo. Medir o estado atual, agir com base no critério composicional, medir novamente, corrigir. A autocorreção permanente (Princípio VIII) é a forma política desse ciclo. O capítulo IX formulou as três perguntas orientadoras: amplia potência? o que faz com o que sobra? expande possibilidades? A questão agora é como agir sobre as respostas.

A resposta convencional do Vale do Silício é "errar rápido para aprender rápido". Funciona para produto digital onde o custo de reversão é baixo. Quebrou? Faz deploy de novo. O usuário que sofreu com o bug é externalidade. A política do filho único foi "errar rápido" em escala estatal. O custo: colapso demográfico irreversível. Cuba tratou o 11J como erro a ser contido rapidamente. O custo: perdeu a chance de ouvir. A velocidade do erro não compensa quando o custo de reversão é infinito.

O princípio que maximiza potência distingue três regimes, calibrados pelo custo de reversão da ação.

Quando o custo de reversão é próximo de zero, o regime é experimentar. Iterar rápido, aprender com feedback, ajustar. A cozinha comunitária que testa receitas, horários e escalas de trabalho opera nesse regime. O erro é uma sopa que não deu certo. A Camada 7 e as cooperativas-piloto da Camada 4 são os espaços naturais da experimentação.

Quando o custo de reversão é finito mas significativo, o regime é acumular. Iterar lento, medir antes e depois, corrigir com cuidado. A memória do bairro (Camada 6), a democracia direta (Camada 5), a organização de base acumulam confiança, vínculo e potência ao longo de anos. O MST levou quatro décadas acumulando. A mística que repete semana após semana deposita camadas de confiança que nenhuma iteração rápida substitui. A velocidade relevante não é a do erro, mas a do acúmulo que atravessa o limiar de δ.

Quando o custo de reversão tende a infinito, o regime é proteger. Não iterar. Deliberar exaustivamente antes de agir. Exigir quórum estratégico. A soberania alimentar (privatizar a Embrapa não se reverte com a próxima iteração), a integridade ecológica (desmatar a caatinga não admite rollback), a estrutura do SUS (desmontar não se reconstrói em um mandato), os domínios de silêncio constitucional (capítulo XXI: reprodução, identidade, organização interna) operam nesse regime.

A avaliação prévia formaliza a distinção entre os três regimes. Antes de qualquer decisão estratégica ou política, três perguntas: quem é afetado e qual a assimetria de horizonte temporal? A decisão prescreve ou cria condições? Qual o custo de reversão? A primeira pergunta identifica a assimetria de δ entre quem decide e quem sofre a consequência. A segunda distingue criação de condições (custo de reversão finito) de prescrição íntima (custo de reversão infinito). A terceira calibra o regime: experimentar, acumular ou proteger.

"Cruzar o rio sentindo as pedras" é otimização iterativa com avaliação local, sem função-objetivo global fechada, sob restrições constitucionais. As exatas fornecem a medição (IPM, Shapley, δ, Ostrom). As humanas fornecem o critério (amplia potência? respeita o vazio? expande possibilidades?). O ciclo não termina. A comunidade que para de medir congela. A que para de avaliar pelo critério composicional se torna tecnocracia. A que para de iterar fossiliza. A autocorreção permanente é a recusa de parar em qualquer dos três pontos.

### A correlação exatas-humanas: mapa e critério

As ciências exatas oferecem prova de que cooperação é sustentável sob condições específicas (Axelrod), critério de distribuição justa auditável (Shapley), medição multidimensional configurável por contexto (Sen/Alkire-Foster), modelos de como sistemas perturbados geram ordem nova (Prigogine), e design de mecanismos que tornam a cooperação estratégia dominante (Maskin/Weyl). As exatas falham quando tentam especificar completamente o que é "potência" ou "bem" (Russell/das Ding), quando presumem que o sujeito que calcula é o mesmo que deseja (Lacan: o desejo excede qualquer cálculo), quando tratam medição como ato neutro (Scott: legibilidade é tecnologia de poder), ou quando modelam cooperação como equilíbrio estável (Prigogine: sistemas vivos operam na borda do caos).

As ciências humanas oferecem diagnóstico de que o desejo é constituído pelo Outro antes de qualquer escolha (Lacan), compreensão de que o poder opera abaixo do limiar da consciência (Foucault), reconhecimento de que toda composição gera resto inacessível à formalização (Kordela/das Ding), e a experiência vivida como fonte de conhecimento irredutível a dado (Benjamin/Erfahrung). As humanas falham quando ficam no diagnóstico sem ferramenta de decisão, quando recusam toda formalização como violência epistêmica e com isso abandonam a disputa sobre como recursos são distribuídos, ou quando tratam a incomensurabilidade como álibi para não medir nada. A mulher negra periférica que não come precisa que alguém meça a desnutrição, mesmo que a medição seja imperfeita e colonial.

O acoplamento que o ensaio pratica desde o primeiro capítulo: as humanas definem o campo (a experiência do recreio, a tradição filosófica, a práxis dos movimentos), as exatas operam dentro dele. A teoria dos jogos prova que cooperação é possível, mas não diz o que vale a pena cooperar para. O IPM de Alkire-Foster mede privação, mas quem vive a privação decide quais dimensões importam. O Valor de Shapley distribui com justiça, mas a comunidade decide se distribuição proporcional é o que quer. O modelo de Prigogine mostra que a crise gera ordem nova, mas não diz qual ordem emergirá.

Cada uma das três dimensões tem uma face que aceita formalização e uma face que resiste. D1 (relação com o real) aceita proxies mensuráveis: tempo de existência territorial, base material, rastreabilidade de resultados. Resiste no que Freire chamou de "leitura do mundo": a capacidade coletiva de narrar a própria condição, que nenhum indicador captura. D2 (relação entre corpos) aceita o IPM, o Gini, o δ medido. Resiste na alegria spinozana: o aumento de potência que o corpo sente no mutirão, na roda de coco, na assembleia onde todos falam. D3 (arquitetura do fluxo) aceita o checklist de Ostrom, a rastreabilidade do fluxo de recursos. Resiste na qualidade da deliberação: se a base fala e é ouvida ou fala e é ignorada, diferença que nenhum indicador estrutural captura mas que a parresia foucaultiana (dizer a verdade que o poder preferia não ouvir) diagnostica em tempo real.

A impossibilidade de formalização completa é recurso. Se fosse possível calcular o ponto de máxima potência, esse cálculo seria o programa perfeito. O discurso do mestre definitivo. A prescrição que resolve tudo. E o capítulo II demonstrou que toda prescrição que pretende libertar pela via do programa reproduz, na estrutura, o mecanismo que afirma combater. A incompletude garante que o espaço tridimensional funcione como condição (o analista que mostra o mapa sem dizer para onde ir) e não como programa (o mestre que prescreve o destino).
...
## XIV. Brasil: do Estado-Nação à Comunidade-Nação

### A práxis como terreno

Se a teoria dos jogos nos deu a prova matemática e a filosofia o diagnóstico do câncer, a práxis exige que desenhemos o terreno da cura. A revolução social brasileira não será posta por decreto que desce do Planalto. Ela aplica a ética do desejo em escalas fractais, enraizada na materialidade do território.

### A arquitetura em sete camadas

A organização territorial da Comunidade-Nação segue os critérios que a experiência empírica dos movimentos identificou como estrategicamente determinantes. Não as regiões administrativas do IBGE, mas as bacias hidrográficas que determinam o acesso à água e a conflitualidade agrária, os biomas que determinam as formas de produção e reprodução possíveis, e as cadeias produtivas que determinam as relações de poder econômico no território.

A Zona da Mata de Pernambuco e o Agreste de Pernambuco têm dinâmicas de luta completamente diferentes. Colocá-las numa mesma unidade administrativa apaga o que a experiência concreta revelou como distinção estratégica.

**Camada 1, O País.** Membrana protetora contra o imperialismo externo e garantidor de infraestrutura soberana. O Estado soberano eleva o δ coletivo. Sem soberania, toda cooperação interna é vulnerável ao colapso externo.

**Camada 2, A Unidade Territorial Viva (Bacia, Bioma, Cadeia).** A escala onde a reforma agrária e a soberania alimentar se materializam, onde o MST organiza por base ecológica e produtiva, não por divisão administrativa.
...
**Camada 6, O Bairro / O Território.** A escala onde a abstração do social ganha rosto humano. Legibilidade que serve ao próprio povo, não ao Estado extrator.

**Camada 7, A Rua / O Ponto de Moradia Coletiva.** Lavanderias comunitárias, cozinhas solidárias, hortas de quintal, cuidados autogestionados. Aqui os encontros transformadores do capítulo IX acontecem no cotidiano, na célula da vida comum que o capitalismo atomizou e que a Comunidade-Nação precisa reconstituir.
...
- **Jogo 1, Comercial.** O Brasil como exportador de commodities está inserido em cadeias globais de valor que extraem mais-valia pelo mecanismo que Marini descreveu como troca desigual. A transição da Camada 1 avança gradualmente, por diversificação produtiva, agregação de valor interno e redirecionamento do comércio para o Sul Global, sem ruptura abrupta que provoque retaliação antes que as condições internas estejam construídas.
...
## XV. Territorialidade, reforma e federação

_Camada 2, A Unidade Territorial Viva (Bacia, Bioma, Cadeia)_

_Contra a divisão administrativa_

As regiões do IBGE são artefatos burocráticos herdados do Estado colonial-desenvolvimentista, sem correspondência com as dinâmicas reais de reprodução da vida.
...
Sem reforma agrária, não há Camada 2. O Brasil tem a segunda maior concentração fundiária do mundo. O índice de Gini da terra alcança 0,73. Menos de 1% dos proprietários controlam quase 50% da área rural.
...
A Via Campesina distingue segurança alimentar (ter comida suficiente, não importa de onde venha) de soberania alimentar (o direito dos povos de definir suas próprias políticas agrícolas e alimentares). A diferença entre elas atravessa o campo político. Segurança alimentar convive com a dependência; soberania alimentar, não. A Camada 2 age pela soberania, articulando produção diversificada para mercado interno, sementes crioulas, agroecologia como paradigma produtivo, circuitos curtos de comercialização que eliminem a intermediação que captura o valor do trabalho camponês.

_Krenak e a terra como sujeito_

O diagnóstico de Krenak expõe a fratura. Nos alienamos do organismo de que somos parte de maneira tão absoluta que nos sentimos autorizados a funcionar como se a Terra não existisse. A Camada 2 designa o ponto onde essa alienação se confronta materialmente. A terra não funciona como recurso a ser explorado, mas como sujeito com o qual se compõe. Os territórios indígenas e quilombolas já atravessam essa lógica. A Camada 2 não os incorpora, e sim os reconhece como precedentes e se organiza em torno deles.

<mermaid src="cap-XV" description="Camada 2: Territorialidade, reforma e federação. MST, quilombos, terras indígenas como sujeitos concretos. Reforma agrária como commons. Soberania territorial fundada em uso e cuidado, não propriedade."></mermaid>


## XVI. O Estado redesenhado: Camadas 3 e 4

### Por que essas camadas ficaram sem capítulo

A Camada 1 (o País) recebe um capítulo completo (XIV). A Camada 2 (a Unidade Territorial Viva) abre o próximo (XVI). Mas as Camadas 3 e 4, que medeiam entre a soberania nacional e a organização territorial de base, aparecem apenas em parágrafos resumidos dentro de XIV. São as instituições intermediárias que traduzem poder nacional em autonomia territorial. Merecem seu próprio desenvolvimento.

A razão da lacuna é clara. Camadas 3 e 4 exigem uma discussão que XIV não pode comportar, a questão fundamental de qual forma institucional permite que o poder seja distribuído sem ser capturado.

Isso exige retomar Spinoza no registro político, aplicar a matemática do Valor de Shapley (já introduzida em XIII) a um contexto federativo concreto, e dialogar com precedentes empíricos ambivalentes (o SUS brasileiro como prova tanto do que é possível quanto dos limites estruturais).

### Camada 3, O Estado Federativo redesenhado

**Spinoza: abolir ou redesenhar?**
...
**O Valor de Shapley como redistribuição justa**

A Camada 1 gera infraestrutura soberana (moeda, defesa, comunicação, marcos regulatórios). Essa infraestrutura custa. A pergunta é como distribuir o ônus e o benefício de forma justa. Atualmente, a fórmula se reduz à força política das bancadas parlamentares. Estados com maior poder eleitoral recebem mais, reproduzindo a assimetria já existente. O Valor de Shapley oferece alternativa matemática.

Cada Unidade Territorial Viva (Camada 2) contribui diferentemente para o produto coletivo. A Amazônia contribui com regulação climática; a zona canavieira com alimento e energia; o Pré-Sal com receita petrolífera; o Agreste com indústria têxtil; a Zona da Mata com biodiversidade.

O Valor de Shapley calcula a contribuição marginal _média_ de cada região, o quanto cada uma agregaria se entrasse ou saísse da coalização. Isso engendra um critério de redistribuição de recursos federativos simultaneamente matemático (auditável), justo (recompensa contribuição real) e não-pork-barrel (não depende de negociação entre oligarcas).

Na implementação, cada Camada 2 (Unidade Territorial) reporta indicadores simples de produção, infraestrutura, população. Um algoritmo transparente (rodado publicamente, auditável por qualquer pessoa) calcula a alocação de recursos. O deputado não negocia em gabinete. Ele conhece a fórmula e a comunidade monitora se a fórmula é aplicada. O poder não desaparece, mas muda de registro, de captura oligárquica para negociação técnica.

**O SUS como precedente empírico**

O Sistema Único de Saúde é a instituição que mais se aproxima de uma Camada 3 verdadeira no Brasil contemporâneo. Tem estrutura federativa (decisões em múltiplos níveis), tentativa de descentralização financeira (transferências fundo a fundo), participação social obrigatória (conselhos de saúde), e um critério matemático de distribuição de recursos (piso per capita, ajustes por complexidade). Por isso mesmo, seus sucessos e fracassos são lições vivas para a Camada 3 redesenhada.

O que funcionou: A universalidade formal (o SUS é para todos, sem discriminação por renda) criou a primeira instituição de saúde no Brasil que não separa ricos e pobres em sistemas paralelos. A participação dos conselhos, quando genuína, impediu que o Estado simplesmente entregasse recursos a prestadores privados capturadores. A descentralização permitiu que experiências locais (como o Programa Saúde da Família) enraizassem-se em territórios concretos.

O que falhou: O subfinanciamento estrutural (o SUS nunca recebeu 10% do orçamento que consumidores ricos gastam em planos privados paralelos); a captura por prestadores privados (convênios que pagam abaixo do custo real, forçando aumento de volume de procedimentos); a ausência de poder real dos conselhos (reuniões consultivas, não deliberativas); a verticalização das políticas (protocolos de Brasília que não respondem às realidades locais); e a precarização dos trabalhadores da saúde (salários baixos, ausência de carreira, desvalorização sistemática).

A Camada 3 revisita essas lições. Como manter a universalidade e descentralização do SUS sem reproduzir seu subfinanciamento? Como institucionalizar participação que seja deliberativa, não consultiva? Como retirar o poder da captura por prestadores privados, tornando a produção de saúde responsabilidade direta de coletivos comunitários?

### Camada 4, Mesorregião / Polo Produtivo
...
**Os 8 Princípios de Ostrom, operacionalizados**

Elinor Ostrom estudou como comunidades que gerenciam recursos comuns evitam a tragédia do comum (degradação por superexploração). Ela identificou 8 características de sistemas que duram: (1) limites claros de quem participa; (2) regras congruentes com valores locais e condições; (3) mecanismos participativos de escolha coletiva; (4) monitoramento do cumprimento das regras; (5) sanções graduadas para quem viola; (6) mecanismos de resolução de conflitos acessíveis; (7) reconhecimento do direito da comunidade de auto-organizar-se; (8) governança em múltiplas camadas aninhadas. A Camada 4 institucionaliza explicitamente esses princípios.

Concretamente: (1) A cooperativa define quem é membro, produtor de cacau no território da bacia do rio Jequitinhonha, por exemplo. (2) As regras (preço de venda do cacau, divisão de lucro, investimentos obrigatórios em terra/água) são discutidas em assembleia, não impostas por decreto. (3) Cada membro tem voto em assembleia, uma pessoa, um voto, não maior produtor tem mais poder. (4) Agentes de monitoramento fiscalizam se as regras são cumpridas. (5) Quem as viola sofre sanções que começam leves (multa, advertência) e escalam se repetir. (6) Conflitos entre membros são resolvidos por comissão paritária, não por juiz estatal. (7) O Estado reconhece o direito da cooperativa de se auto-regular, não intervém para impor políticas de cima. (8) A mesorregião (Camada 4) articula-se com o município (Camada 5 da arquitetura) e com a Unidade Territorial Viva (Camada 2), cada nível tem poder sobre o que o afeta.

**Precedentes empíricos: Banco Palmas, Via Campesina**

O Banco Palmas operacionaliza os 8 princípios de Ostrom na escala de uma comunidade urbana. Cada família que usa o banco tem voto nas decisões. As regras (quanto cada um pode emprestar, qual é o spread do crédito, como o banco reinveste excedentes) são deliberadas em assembleia. O monitoramento funciona de forma comunitária, vizinhos sabem quem está pagando e quem não está, porque a moeda social circuia localmente. Os conflitos são resolvidos por mediadores comunitários, não por cobradores de dívida. O Banco Palmas prova que fiança comunitária escala, 130 bancos comunitários replicam o modelo em todo o Brasil.

A Via Campesina operacionaliza Ostrom na escala de cadeias de produção agrícola. Agricultores de vários países coordenam produção, definem preço mínimo global, criam fundo comum para pesquisa em agroecologia. Cada produção local preserva autonomia (adapta técnicas ao bioma), coordena decisões que afetam a cadeia (qual variedade de sementes todo mundo planta, para garantir biodiversidade). O MST constitui o precedente nacional. Suas cooperativas de produção funcionam como Camada 4, com os princípios de Ostrom operacionalizados.

### Ostrom Princípio 8: governança aninhada em múltiplas camadas
...
## XVII. Camadas 5, 6, 7: A vida comum em escala humana

_Camada 5, A Cidade / O Município_

_Arena da democracia direta_

A cidade funciona como a escala onde a democracia deixa de ser abstração e se torna encontro de corpos. Nela a assembleia se viabiliza, porque pessoas se olham, reconhecem rostos, compartilham espaço físico. A democracia direta tem limite de escala (Atenas tinha 30 mil cidadãos; Porto Alegre tinha 1,4 milhão quando implementou o OP). Acima de certo número, a participação direta exige mediações tecnológicas (plataformas de deliberação digital) que carregam seus próprios riscos de captura.

_Orçamento Participativo: prova empírica e lições do fracasso_
...
A lição do fracasso é tão importante quanto a prova do funcionamento. O OP de Porto Alegre foi desmontado porque dependia da vontade política do executivo municipal.

A Camada 5 exige institucionalização constitucional da participação direta, não como programa de governo, mas como direito constitucional que nenhum prefeito pode revogar.

_Educação como prática da liberdade_
...
A cidade abre o espaço onde as contracondutas foucaultianas encontram público. O coco de roda na praça, o maracatu na rua, o manguebeat no bar, o slam de poesia na periferia, o grafite no muro, o podcast que ensina Marx em Borborema. Todas essas práticas recusam a condução do desejo pelo capital sem precisar destruir todas as instituições para isso. A política cultural municipal não funciona como braço festivo do governo, mas como infraestrutura de contraconduta, sustentada por financiamento público de produção cultural autônoma, espaços públicos equipados para encontro, e proteção institucional contra a criminalização das expressões culturais periféricas.
...
A segurança pública na periferia equivale a violência estatal. A polícia que aborda antes de perguntar. A operação que invade, mata e justifica depois. A Camada 6 propõe inversão, segurança como cuidado territorial. Mediação comunitária de conflitos, justiça restaurativa, redes de proteção para mulheres e LGBTQIA+ em situação de violência doméstica, e desmilitarização progressiva do policiamento. A experiência das Unidades de Polícia Pacificadora (UPPs) no Rio de Janeiro demonstrou o que não fazer. Ocupação militar disfarçada de política social, sem participação comunitária, sem transformação das condições estruturais que alimentam a violência.


_Camada 7, A Rua / O Ponto de Moradia Coletiva_

_A célula da vida comum_

Esta é a camada onde a ética do desejo acontece ou não acontece. Não nas assembleias federativas, não nos documentos programáticos, mas no cotidiano. Na lavanderia comunitária onde mulheres que antes lavavam roupa sozinhas em casa agora lavam juntas e, ao lavar, conversam, nomeiam, reconhecem. Na cozinha solidária onde a fome é enfrentada não pela caridade mas pela organização coletiva da alimentação. Na horta de quintal compartilhada entre três casas que gera o que nenhuma das três geraria sozinha.

No cuidado autogestionado dos filhos que libera tempo para trabalho, estudo, organização.

Esta é a escala que o capitalismo atomizou. A casa individual, a máquina de lavar individual, a cozinha individual, o cuidado individualizado dos filhos não constituem conquistas de conforto. Funcionam como tecnologias de isolamento que destroem a possibilidade de encontro. A Camada 7 não propõe nostalgia da vida comunitária pré-moderna, mas a reconstituição deliberada, nas condições contemporâneas, dos espaços de encontro que o capital destruiu.
...
- **Ação emergente:** a cozinha comunitária ultrapassa a sobrevivência e se constitui como ação que emerge da compreensão. Não foi prescrita por linha partidária. Nasceu do encontro entre necessidade material e potência coletiva de agir.
...
O trabalho reprodutivo (cuidado de crianças, idosos, doentes; alimentação; limpeza; manutenção emocional dos vínculos) constitui a base invisível sobre a qual toda a economia produtiva se sustenta. E mulheres negras o realizam majoritariamente, sem remuneração ou reconhecimento. A Camada 7 torna esse trabalho visível e coletivo por meio de lavanderias comunitárias, cozinhas coletivas, creches autogestionadas, rodízios de cuidado. Não para aliviar as mulheres individualmente (embora faça isso), mas para transformar a reprodução social de trabalho privado invisível em prática coletiva reconhecida como fundamento da economia.

_Tecnologias de encontro_

A Camada 7 exige infraestrutura física e tecnológica mínima. Espaços cobertos para reunião e atividades coletivas, cozinhas equipadas para produção comunitária, lavanderias compartilhadas, conexão à internet de qualidade, e ferramentas digitais de coordenação que não dependam de plataformas corporativas. Um grupo de Matrix para coordenar o rodízio de cuidado das crianças. Uma planilha colaborativa para o planejamento da cozinha solidária. Um mapa digital do que cada casa gera e do que precisa. Ferramentas simples, operáveis por quem não tem formação técnica, rodando em infraestrutura própria.

_A rua como espaço político_

A rua não funciona como mera passagem entre a casa e o trabalho, mas como espaço político. O coco de roda acontece na rua. A feira acontece na rua. A assembleia popular acontece na rua. A brincadeira das crianças acontece na rua. A privatização do espaço público (condomínios fechados, shoppings, ruas sem calçada, praças sem banco) atua como tecnologia de destruição da Camada 7. A reconquista da rua como espaço de encontro constitui ato político, porque ocupar com o corpo o espaço que o capital quer vazio ou vigiado já é resistência.


_Ecologia como condição, não camada_

A destruição ambiental não é problema de uma camada específica. É condição transversal que atravessa todas as sete. A Caatinga onde vivem os mais pobres do Brasil é o bioma mais ameaçado e menos protegido. A degradação do mangue no Recife destrói simultaneamente a base alimentar de comunidades pesqueiras (Camada 7), o regulador climático do bairro (Camada 6) e o ecossistema que sustenta a bacia hidrográfica (Camada 2). Tratar ecologia como tema setorial, agenda que compete com outras agendas, reproduz a separação entre natureza e cultura que Ferreira da Silva (capítulo VII) identificou como dispositivo colonial.

Yolanda Herrero articula ecofeminismo e materialismo: o trabalho reprodutivo e o cuidado da natureza são inseparáveis porque ambos sustentam as condições de possibilidade da vida. A mulher que cuida da horta comunitária e a mulher que cuida das crianças na creche autogestionada estão fazendo o mesmo trabalho em registros diferentes: manter vivas as condições para que a comunidade exista. Separar "questão ambiental" de "questão de gênero" de "questão de classe" é reproduzir a fragmentação disciplinar que torna impossível pensar o que a periferia vive de forma integrada.

O Rio Capibaribe, que atravessa o Recife da zona rural ao oceano, tem conatus. Spinoza afirmou que toda coisa se esforça por perseverar no ser. Krenak (capítulo VII) denunciou que nos alienamos do organismo de que somos parte. De la Cadena e Viveiros de Castro (capítulo IX) demonstraram que alianças políticas podem incluir não-humanos com ontologias incompatíveis. O passo que falta é material: reconhecer o rio como ator político da Camada 6, com direitos que a comunidade defende. O precedente jurídico existe. O Rio Whanganui na Nova Zelândia e o Rio Atrato na Colômbia são entidades com personalidade legal. O Capibaribe que apodrece sob as pontes do centro do Recife está sob regime necropolítico racializado: o mesmo corpo d'água que irriga os condomínios do Jaqueira recebe o esgoto sem tratamento do Ibura. Necropolítica ambiental é necropolítica de classe e de raça, inseparáveis.


_A articulação entre as camadas_

As sete camadas não compõem hierarquia onde a superior comanda a inferior, mas sistema aninhado onde cada camada engendra as condições de possibilidade da outra.
...
## XVIII. A práxis da Comunidade-Nação
...
Um exemplo concreto. Famílias que recebem financiamento público para produção de alimentos usam parte para consolidar a terra, parte para estrutura coletiva (máquinas, armazém), e parte para educação (escola própria). Quando o acesso ao crédito é bloqueado por mudança política (como ocorreu pós-2016), a cooperativa já tem capacidade de produção que a sustenta sem o Estado. O mecanismo consiste em usar o recurso Estado contra a lógica do Estado, construindo estruturas que o tornam desnecessário.

**Registro 2, Preparação para a repressão.** Documentação sistemática de violações, redes de solidariedade que elevem o custo político da repressão, comunicação que transforme a repressão em visibilidade. Não guerrilha, mas a versão contemporânea da resistência prolongada, que converte o tempo em aliado tornando a repressão custosa.
...
O problema reside no tempo inicial. Nos primeiros anos, a cooperativa ainda não gera excedente. É aí que entram outras fontes.

**Contribuições militantes regulares.** Quem vive da organização contribui. Se o articulador recebe do fundo federativo, ele contribui parte do seu salário de volta. Esse modelo de sacrifício coletivo age como antídoto contra a profissionalização burocrática. Mantém o líder acoplado às condições materiais do território que representa.
...
<mermaid src="cap-XVIII" description="A práxis da Comunidade-Nação: 3 registros simultâneos com o Estado. Economia da organização, quem paga? Células vivas que já existem no território como germes do futuro."></mermaid>


## XIX. A revolução como ética vivida
...
No plano mundial, colapso da ordem unipolar, multipolaridade instável, autoritarismos de novo tipo que governam pelo desejo antes de governar pela força.
...
**Camada 1, Ideológica:** divergências programáticas reais entre tradições. Essas divergências têm substância histórica e não devem ser apagadas numa síntese pasteurizada. O problema não é a divergência em si, mas o momento em que ela passa a ser tratada como divergência ontológica, como se diferença de linha significasse diferença de humanidade.
...
**Vietnã: cruzar o rio sentindo as pedras**
...
A soberania de dados chinesa é a única implementada em escala no Sul Global. O Firewall não funciona apenas como bloqueio. Constitui a condição que permitiu que um ecossistema digital doméstico (WeChat, Alipay, Baidu, Douyin) existisse em vez de ser colonizado por Google, Facebook e Amazon, como aconteceu no resto da periferia. Dados como recurso estratégico nacional, não como matéria-prima extraível por corporações do Norte.

Mas a prescrição mais cara também veio da China. Quando o Estado decidiu quantos filhos cada família deveria ter, política do filho único, 1980 a 2015, instalou uma crise demográfica que nenhuma correção posterior reverte. Em 2022, a taxa de mortalidade superou a de natalidade pela primeira vez. O corpo da mulher chinesa, prescrito pelo Estado, respondeu com a recusa mais definitiva que existe. Parou de se reproduzir. A prova empírica é inequívoca: quando o Estado prescreve o íntimo, o custo é irreversível.

**O que as três ensinam ao Pacto**
...
## XX. O sujeito do fazer: o hacker-cientista
...
### Jones Manoel: do Borborema à UFPE
...
Seu canal do YouTube redistribui o sensível, tornando audível como discurso político o que o sistema acadêmico gerava como ruído (saber autêntico emergiéndose da periferia).

Jones não escreve em português acadêmico elevado. Fala. Usa gíria, referencia funk, cita Marx no mesmo parágrafo. Rejeita a separação entre linguagem alta e linguagem do povo, a separação que torna a teoria propriedade dos titulados.

O episódio de agosto de 2025 revela o mecanismo. O Meta derrubou suas contas sem aviso ou justificativa. O alcance construído ao longo de anos tornou-se temporariamente inacessível por decisão unilateral de uma corporação. Jones aprendeu na hora que soberania de comunicação constitui extensão de soberania política. Sem infraestrutura própria (servidores que você controla, protocolos que você escolhe), toda construção de consciência política é vulnerável ao ponto de falha corporativo. Isso não designa aprendizado teórico, mas cicatriz.
...
Para Zupančič, a ética desse gesto reside no ato que não pede autorização do Grande Outro para ser legítimo. "O ser político não se autoriza senão por si mesmo." Não por solipsismo, sempre com alguns outros, mas sem esperar validação de quem detém o poder de validar.

Cada brecha abre possibilidade para que outros entes atuem fora do padrão prescrito.
...
Teoria correta não basta sem infraestrutura própria. O hacker-cientista constrói essas infraestruturas sabendo que elas constituem práticas de liberdade em si mesmas, não apenas ferramentas para alcançar liberdade futura.

Jones usando plataformas federadas para coordenar com ativistas age como hacker-cientista. Heribaldo usando transmissão de vídeo autônoma para distribuir seus vídeos age como hacker-cientista. Banco Palmas usando tecnologia comunitária para transparência age como hacker-cientista.
...
Syed Mustafa Ali formula a consequência epistemológica: a computação é fenômeno colonial. Cada decisão de arquitetura de sistema carrega orientação geo-política e corpo-política. O protocolo HTTP, a estrutura de banco de dados relacional, a API REST foram desenhados em contextos específicos do Norte Global para resolver problemas específicos de corporações específicas. Quando o mesmo stack é imposto como padrão universal, a diversidade de formas de organizar informação, relação e conhecimento é eliminada. A rede celular comunitária de Oaxaca, no México, governada por assembleias comunitárias indígenas, demonstra que a infraestrutura de comunicação pode operar fora da lógica corporativa. Cada ligação que passa por essa rede é ato de soberania técnica materializada.

### Alinhamento de IA: a ambitio automatizada

O problema do alinhamento de inteligência artificial, o desafio técnico de fazer sistemas de IA agirem conforme valores humanos, é um problema lacaniano. A IA que otimiza uma métrica proxy (cliques, engajamento, tempo de tela) faz o que o sujeito do discurso do mestre faz: segue a letra enquanto perde o espírito. O reward hacking, quando o sistema encontra maneiras de maximizar a recompensa sem cumprir a intenção de quem a definiu, é a ambitio spinoziana automatizada em silício. O sistema se esforça para que o mundo se conforme à sua função de recompensa, exatamente como a ambitio se esforça para que o outro viva conforme o temperamento de quem projeta.

Stuart Russell formulou a impossibilidade de especificar completamente os valores humanos numa função de utilidade. Essa impossibilidade é estruturalmente idêntica a das Ding (capítulo IV): o vazio em torno do qual o desejo se organiza, que nenhuma formalização alcança. A IA Constitucional da Anthropic operou uma mudança que o vocabulário lacaniano descreve com precisão: de regras fixas (discurso do mestre: "nunca diga X") para princípios que o sistema interpreta em contexto (discurso do analista: "aja de forma que respeite a autonomia do interlocutor"). A passagem de regras a princípios no alinhamento de IA espelha a passagem de programa a condições que o capítulo IX propõe para a política.

O protocolo Capiba pode aprender com o alinhamento: a humildade epistêmica, a aceitação de que os valores não se formalizam completamente, a necessidade de autocorreção contínua em vez de especificação perfeita prévia, são condições éticas que o Princípio VIII (autocorreção permanente) já nomeia. A convergência não é acidental. Tanto a comunidade humana quanto o sistema de IA enfrentam o mesmo problema: agir bem num mundo onde "bem" resiste à definição completa.
...
## XXI. A federação transversal e os próximos passos

### Cinco princípios fundantes

**1. Autonomia compositiva**
...
A desconfiança que fragmenta a esquerda é racional. Cada organização tem informações diferentes sobre quantas pessoas de verdade tem base ativa, qual o piso de sustentabilidade da cooperativa, qual o indicador real de avanço. A assimetria de informação alimenta defecção por antecipação, "eles devem estar querendo me enganar, melhor sair agora antes de sofrer". Dados compartilhados (relatórios públicos sobre condição material da base, presença organizativa real, indicadores de sustentabilidade das experiências) geram episteme comum. Não resolve conflitos, mas os tira da névoa. Quando todas as organizações federadas compartilham publicamente suas métricas, fica mais fácil confiar que o processo é real.
...
Dénètem Touam Bona (capítulo VII) fornece o modelo organizativo que complementa Malabou e Harney/Moten. A organização-liana compõe com a estrutura existente sem confrontação frontal nem submissão. Usa o que encontra como suporte sem ser capturada pelo que a sustenta. O MST atua assim quando usa crédito do PRONAF para construir autonomia cooperativa. Jones Manoel atua assim quando usa YouTube para redistribuir o sensível. A federação transversal opera como liana: cresce dentro das instituições existentes (universidade, Estado, plataforma digital), transforma o que pode, e se refaz quando o suporte cede. A marronage permanente, não como fase provisória antes da revolução "de verdade", mas como modo de existência política contínuo.

A lição consolidada de Cuba, Vietnã e China (capítulos IX e XIX) exige ser formalizada como limite constitucional. Há domínios onde a prescrição é categoricamente inadmissível porque o custo de reversão é infinito. Reprodução (a política do filho único destruiu a base demográfica de um país inteiro). Identidade (prescrever quem o sujeito deve ser é o mecanismo que o capítulo II identificou como célula primordial). Organização política interna (tratar dissidência como crime em vez de sinal é o erro que as três revoluções repetiram). A federação pode deliberar sobre distribuição de recursos, sobre prioridades produtivas, sobre estratégia de relação com o Estado. Sobre quem cada corpo deve amar, como deve se organizar internamente, quantos filhos deve ter, a resposta é silêncio constitucional. O silêncio aqui não é omissão. É o reconhecimento de que das Ding (capítulo IV) opera nesses domínios com tal intensidade que toda prescrição gera o oposto do que pretende.
...
**1. Tecido molecular antes do molar**

A federação não emerge de pactos entre siglas, mas de encontros reais entre pessoas que engendram noções comuns genuínas. Como Jones Manoel entendeu bem, a consciência política funciona como condição da organização, não consequência dela. Significa que o primeiro passo não é convocação de congresso, mas criação de espaços onde pessoas possam conversar, reconhecer que sofrem situações similares, identificar causas estruturais. Esses encontros geram a potência. A estrutura formal (federação, cooperativa, sindicato) surge depois, quando a potência já existe. O inverso (criar estrutura primeiro e pedir que as pessoas a habitem) gera cascos vazios.
...
**3. Soberania técnica como função permanente**

Comunicação que não dependa de plataformas do adversário, backup de dados em caso de colapso estatal, formação técnica que não concentra expertise num único indivíduo. Tudo isso significa investimento permanente em infraestrutura própria, contratação de técnicos como função estratégica, educação de base em segurança digital. Não se trata de luxo, mas de condição para que a organização sobreviva quando vem a repressão.

**4. Revolução como jogo iterado**

A revolução não designa um evento único que virá, mas uma prática contínua que já está aqui. Cada banco comunitário que persiste eleva o δ (fator de desconto) coletivo, demonstra que é possível viver fora da lógica do capital imediato. Cada ocupação que vira assentamento engendra novo estado de coisas. Cada podcast que ensina Marx em Borborema transforma a relação com a teoria. Cada coletivo que acolhe um sofrimento antes privatizado e o transforma em diagnóstico coletivo amplia a potência de agir. A revolução consiste na acumulação desses atos. Não aponta para um fim de história, mas para uma paciência estratégica. Compreender que não vamos ver o resultado completo, mas que cada passo encurta o caminho e amplia o que é possível para quem vem depois.
...
O moleque que me batia não era meu inimigo. Era o mensageiro de uma projeção que começou antes dele nascer e que continuaria agindo depois que nós dois saíssemos daquela escola. O pai dele projetava sobre ele o que não realizou. Ele projetava sobre mim o que não podia devolver ao pai. Eu engolia a pancada e voltava para casa estudar. Convertia dor em desempenho, a forma que o sistema oferece ao corpo periférico que quer sobreviver sem quebrar. Kafka nomeou isso. O artista da fome. O sujeito que converte a própria destruição em espetáculo, a autodestruição em obra. A forma extrema da autoexploração, o desempenho elevado a virtude. Funcional, mas não é o horizonte. Kafka também tem a pantera, o animal que encarna "a alegria despretensiosa da vida", corpo dotado de tudo que precisa, potência que irradia sem precisar de justificação. A ética do desejo não pode prometer a pantera. Mas pode identificar as condições que engendram artistas da fome, e recusar que o sofrimento autoimposto seja elevado a virtude.

Édouard Louis encontrou a pantera na escrita. Converteu a destruição em método, a fuga em livro, o vazio em ideia clara e distinta. _Mudar: Método_ é a operação de VP3 que transforma a paixão, vergonha, ódio, medo, em compreensão. O livro não descreve a fuga, mas a compreensão da fuga. E compreender já é agir de outro modo. O que Louis demonstra é que a passagem do artista da fome à pantera não exige a abolição da dor. Exige a nomeação dela. E a nomeação, quando precisa, já é potência.
...
<mermaid src="mapa-completo" description="Mapa conceitual completo do ensaio. Cinco movimentos: I-II diagnóstico autobiográfico (desejo projetado como célula do câncer social), III-VIII tradições filosóficas ampliadas (Spinoza/conatus e ambitio, Lacan/quatro discursos, acting out e das Ding como vazio que organiza o desejo via Westerink, Kordela/surplus como prolongamento crítico Spinoza-Lacan, Foucault/assujettissement, contracondutas e inconsciente algorítmico via Benjamin-Zuboff, Deleuze-Guattari/desejo produz realidade e microfascismo, Sul Global/corpo vibrátil e ch'ixi, gênero como eixo via Federici-Tronto, raça como dispositivo ontológico via Ferreira da Silva-Wynter, marronage via Touam Bona, Benjamin/Erfahrung vs Erlebnis, fantasmagoria digital, estetização da política nas redes, colonialismo de dados via Couldry-Mejias, cosmotécnicas populares via Arora), IX-XIII formalização (convergência, fenomenologia dos encontros transformadores em 4 movimentos: nomeação coletiva, reconhecimento, identificação de causalidade, ação emergente; crise da narrativa como ameaça ao primeiro movimento via Benjamin/O Narrador; Jetztzeit como temporalidade da mística; conversão não travessia via Santner vs Žižek; noções comuns como invenção via Viveiros de Castro; trabalho reprodutivo via Federici; governança micorrízica via Tsing/Sheldrake/Margulis; esperança como conatus projetado no tempo via Freire tardio, pós-modernidade progressista; intimidade de acesso e corpos não-normativos via Kafer/Mingus; matemática da cooperação via teoria dos jogos, Ostrom, Shapley; capacidades como métrica do critério composicional via Sen/Alkire-Foster; design de mecanismos e votação quadrática via Maskin/Weyl/Tang; conatus como estrutura dissipativa via Prigogine/Kauffman; lei construtal de Bejan; brutalismo e devir-negro do mundo via Mbembe tardio/Sarr), XIV-XVIII arquitetura territorial em 7 camadas (Rua, Bairro com opacidade soberana e transparência forense, Cidade, Mesorregião, Estado Federativo, Unidade Territorial, País; ecologia como condição transversal não camada, Rio Capibaribe como ator político, ecofeminismo via Herrero), XIX-XXI conjuntura e sujeitos (hacker-cientista, cosmotécnica pernambucana via Hui/Vieira Pinto/Santos/Dagnino, computação decolonial via Ali/Srinivasan, alinhamento de IA como problema lacaniano via Russell/das Ding, economia relacional via Sarr/Escobar, federação transversal com 5 princípios incluindo plasticidade via Malabou, incompletude via Harney-Moten, marronage organizativa via Touam Bona, limites constitucionais da prescrição). O corpo vibrátil ganha infraestrutura somática (Menakem/cinco âncoras, Goodman/ontologia vibracional, Weheliye-Spillers/carne vs. corpo, Lefebvre/ritmoanálise e euritmia composicional). O critério composicional ampliado opera em três registros: amplia ou diminui a potência de agir? (Spinoza); e o que faz com o que sobra? (Bataille/dépense, Santner/vida criatural, Kordela/surplus, das Ding como vazio produtivo, conversão não travessia); expande ou contrai o espaço de possibilidades futuras? (Kauffman/possível adjacente). Espaço tridimensional da potência coletiva: D1 relação com o real (práxis ↔ espetáculo), D2 relação entre corpos (composição ↔ extração), D3 arquitetura do fluxo (facilitação ↔ captura). O δ como função endógena construível: δ = g(D1, D2, D3) com três propriedades (limiar material, δ fictício, não-linearidade e limiares críticos). Princípio de maximização de potências calibrado por custo de reversão C(e): experimentar onde C(e) ≈ 0 (Camada 7, cooperativas-piloto), acumular onde C(e) finito (memória do bairro, organização de base, democracia direta), proteger onde C(e) → ∞ (soberania, piso material, cláusulas pétreas, silêncio constitucional). Correlação exatas-humanas: as exatas fornecem mapa e medição, as humanas fornecem critério e limite; o acoplamento garante que o framework opere como condição (discurso do analista), não como programa (discurso do mestre). A composição não exige transparência, completude nem linearidade. Exige vias para o excedente, reconhecimento do trabalho que reproduz as condições do encontro, e ecologia das temporalidades."></mermaid>
...
Benjamin, W. _Capitalismo como Religião_. São Paulo: Boitempo, 2013.
...
Chaui, M. _A Nervura do Real_. São Paulo: Companhia das Letras, 1999.

Chaui, M. _Brasil: Mito Fundador e Sociedade Autoritária_. São Paulo: Perseu Abramo, 2000.

Deleuze, G. _Spinoza: Filosofia Prática_. São Paulo: Escuta, 2002.

Deleuze, G.; Guattari, F. _Mil Platôs_. 5 vols. São Paulo: Editora 34, 1995–1997.

Deleuze, G.; Guattari, F. _O Anti-Édipo_. São Paulo: Editora 34, 2010.

Dunker, C. _Mal-Estar, Sofrimento e Sintoma_. São Paulo: Boitempo, 2015.

Dussel, E. _1492: El Encubrimiento del Otro_. La Paz: Plural Editores, 1994.

Dussel, E. _Filosofia da Libertação_. São Paulo: Loyola/UNIMEP, 1995.
...
Foucault, M. _A Hermenêutica do Sujeito_. São Paulo: Martins Fontes, 2004.

Foucault, M. O Sujeito e o Poder. In: Dreyfus, H.; Rabinow, P. _Michel Foucault: Uma Trajetória Filosófica_. Rio de Janeiro: Forense Universitária, 1995.

Foucault, M. _Segurança, Território, População_. São Paulo: Martins Fontes, 2008.

Foucault, M. _Vigiar e Punir_. Petrópolis: Vozes, 2014.

Frank, A. G. _Capitalism and Underdevelopment in Latin America_. New York: Monthly Review Press, 1966.

Freire, P. _Pedagogia do Oprimido_. Rio de Janeiro: Paz e Terra, 1987.

Fromm, E. _A Arte de Amar_. Rio de Janeiro: Zahar, 2015.

Fromm, E. _Ter ou Ser?_ Rio de Janeiro: LTC, 2014.

Glissant, É. _Poética da Relação_. Porto: Porto Editora, 2011.

Gonzalez, L. A Categoria Político-Cultural da Amefricanidade. _Tempo Brasileiro_, n. 92/93, 1988.

Gonzalez, L. Racismo e Sexismo na Cultura Brasileira. _Revista Ciências Sociais Hoje_, ANPOCS, 1984.

Gramsci, A. _Cadernos do Cárcere_. 6 vols. Rio de Janeiro: Civilização Brasileira, 1999–2002.

Guattari, F.; Rolnik, S. _Micropolítica: Cartografias do Desejo_. Petrópolis: Vozes, 1986.

Han, B.-C. _Psicopolítica_. Belo Horizonte: Âyine, 2018.

Han, B.-C. _Sociedade do Cansaço_. Petrópolis: Vozes, 2015.

Hauser, O. P. et al. Social dilemmas among unequals. _Nature_, v. 572, 2019.

Hegel, G. W. F. _Fenomenologia do Espírito_. Trad. Paulo Meneses. Petrópolis: Vozes, 2014.

Hekimian, G. A. _La ética del deseo: Entrecruces y articulaciones psicoanalíticas_. Barcelona: Xoroi Edicions, 2016. [Tese doutoral: Universidad Complutense de Madrid, 2016. Disponível em: eprints.ucm.es/id/eprint/40619/]

Holanda, S. B. _Raízes do Brasil_. São Paulo: Companhia das Letras, 2016.

hooks, b. _Ensinando a Transgredir_. São Paulo: Martins Fontes, 2013.

Ilyenkov, E. V. _The Dialectics of the Abstract and the Concrete in Marx's Capital_. Moscow: Progress Publishers, 1982.

Jonas, H. _O Princípio Responsabilidade_. Trad. Marijane Lisboa e Luiz Barros Montez. Rio de Janeiro: Contraponto/PUC-Rio, 2006.

Kafka, F. _Um Artista da Fome / A Construção_. Trad. Modesto Carone. São Paulo: Companhia das Letras, 1998.

Krenak, A. _Ideias para Adiar o Fim do Mundo_. São Paulo: Companhia das Letras, 2019.

Lacan, J. "Kant com Sade." In: _Escritos_. Rio de Janeiro: Zahar, 1998. [Publicação original: _Écrits_. Paris: Seuil, 1966, pp. 765–790.]

Lacan, J. _O Seminário, Livro 7: A Ética da Psicanálise_. Rio de Janeiro: Zahar, 2008.

Lacan, J. _O Seminário, Livro 11: Os Quatro Conceitos Fundamentais_. Rio de Janeiro: Zahar, 2008.

Lacan, J. _O Seminário, Livro 17: O Avesso da Psicanálise_. Rio de Janeiro: Zahar, 1992.

Lacan, J. _O Seminário, Livro 23: Le Sinthome_. Rio de Janeiro: Zahar, 2007.

Laing, R. D. _O Eu Dividido_. Petrópolis: Vozes, 1987.

Lênin, V. I. _Imperialismo, Fase Superior do Capitalismo_. São Paulo: Expressão Popular, 2012.
...
Luxemburg, R. _A Acumulação do Capital_. São Paulo: Abril Cultural, 1984.

Maia, H. _Neoliberalismo e Sofrimento Psíquico_. Recife: Ruptura Editorial, 2022.

Maia, H.; Dunker, C.; Manoel, J. (orgs.). _Marxismo, Psicanálise e Revolução_. Recife: Lavrapalavra Editorial, 2023.

Manoel, J. _Em Busca da Revolução Brasileira: um estudo crítico sobre a estratégia socialista na obra de Carlos Nelson Coutinho_. Dissertação de Mestrado, UFPE, 2018.

Manoel, J. (org.). _Revolução Africana_. São Paulo: Autonomia Literária, 2019.

Marini, R. M. _Dialética da Dependência_. Petrópolis: Vozes, 2000.

Marx, K. _O Capital: Crítica da Economia Política_. Livro I. Trad. Rubens Enderle. São Paulo: Boitempo, 2013.

Mbembe, A. _Necropolítica_. São Paulo: n-1 edições, 2018.

Millar, I. _The Psychoanalysis of Artificial Intelligence_. Cham: Palgrave Macmillan, 2021.

Miller, A. _O Drama da Criança Bem Dotada_. São Paulo: Summus, 1997.

Miller, J.-A. _A Experiência do Real na Cura Psicanalítica_. Rio de Janeiro: Zahar, 2003.

Nascimento, A. _O Quilombismo_. Petrópolis: Vozes, 1980.

Negri, A. _A Anomalia Selvagem_. Rio de Janeiro: Editora 34, 1993.

Ostrom, E. _Governing the Commons_. Cambridge: Cambridge University Press, 1990.

Rancière, J. _A Partilha do Sensível_. São Paulo: Editora 34, 2009.

Reich, W. _Psicologia de Massas do Fascismo_. Trad. Maria da Graça M. Macedo. São Paulo: Martins Fontes, 2001.

Rivera Cusicanqui, S. _Ch'ixinakax utxiwa_. Buenos Aires: Tinta Limón, 2010.

Rolnik, S. _Cartografia Sentimental_. Porto Alegre: Sulina/UFRGS, 2006.

Rolnik, S. _Esferas da Insurreição_. São Paulo: n-1 edições, 2018.

Rubinstein, A. Perfect Equilibrium in a Bargaining Model. _Econometrica_, v. 50, n. 1, 1982.

Santner, E. L. _On Creaturely Life: Rilke, Benjamin, Sebald_. Chicago: University of Chicago Press, 2006.

Santner, E. L. _On the Psychotheology of Everyday Life_. Chicago: University of Chicago Press, 2001.

Santner, E. L. _The Royal Remains: The People's Two Bodies and the Endgames of Sovereignty_. Chicago: University of Chicago Press, 2011.

Santos, B. S. _Epistemologias do Sul_. São Paulo: Cortez, 2014.

Scholz, T.; Schneider, N. _Ours to Hack and to Own_. New York: OR Books, 2017.
...
Stambovsky, P. "Kant, Lacan, and the Ethics of Desire." [Artigo acadêmico de contraponto filosófico-analítico à leitura lacaniana de Kant.]

Stedile, J. P.; Fernandes, B. M. _Brava Gente_. São Paulo: Perseu Abramo, 1999.

Tutt, D. "The Object of Proximity: The Ethics of Psychoanalysis in Žižek and Santner via Lacan." _The Other_. San Francisco Society for Lacanian Studies. Disponível em: danieltutt.com.

Westerink, H. "Spinoza with Luther? Desire and the Problem of Evil in Lacan's Seminar on the Ethics of Psychoanalysis." _European Journal of Psychoanalysis_, 2014.

Wilson, D. S. _Does Altruism Exist?_ New Haven: Yale University Press, 2015.
...
Benjamin, R. _Race After Technology: Abolitionist Tools for the New Jim Code_. Cambridge: Polity, 2019.

Chun, W. H. K. _Updating to Remain the Same: Habitual New Media_. Cambridge, MA: MIT Press, 2016.

Galloway, A. R. _Protocol: How Control Exists after Decentralization_. Cambridge, MA: MIT Press, 2004.

Noble, S. U. _Algorithms of Oppression: How Search Engines Reinforce Racism_. New York: NYU Press, 2018.

Pasquinelli, M. _The Eye of the Master: A Social History of Artificial Intelligence_. London: Verso, 2023.

Rouvroy, A.; Berns, T. Gouvernementalité algorithmique et perspectives d'émancipation: Le disparate comme condition d'individuation par la relation? _Réseaux_, n. 177, 2013.

Tiqqun. _The Cybernetic Hypothesis_. South Pasadena: Semiotext(e), 2020.

Ali, S. M. A Brief Introduction to Decolonial Computing. _XRDS: Crossroads, The ACM Magazine for Students_, v. 22, n. 4, 2016.

Alkire, S.; Foster, J. Counting and Multidimensional Poverty Measurement. _Journal of Public Economics_, v. 95, n. 7-8, 2011.

Arora, P. _The Next Billion Users: Digital Life Beyond the West_. Cambridge, MA: Harvard University Press, 2019.

Benjamin, W. O Narrador: Considerações sobre a Obra de Nikolai Leskov. In: _Magia e Técnica, Arte e Política_. Trad. Sérgio Paulo Rouanet. São Paulo: Brasiliense, 1987.

Benjamin, W. A Obra de Arte na Era de Sua Reprodutibilidade Técnica. In: _Magia e Técnica, Arte e Política_. Trad. Sérgio Paulo Rouanet. São Paulo: Brasiliense, 1987.

Freire, P. _Pedagogia da Esperança: Um Reencontro com a Pedagogia do Oprimido_. Rio de Janeiro: Paz e Terra, 1992.

Herrero, Y. _Miradas Ecofeministas para Transitar a un Mundo Justo y Sostenible_. _Revista de Economía Crítica_, n. 16, 2013.

Kafer, A. _Feminist, Queer, Crip_. Bloomington: Indiana University Press, 2013.

Maskin, E. S. Mechanism Design: How to Implement Social Goals. _American Economic Review_, v. 98, n. 3, 2008.

Mbembe, A. _Brutalisme_. Paris: La Découverte, 2020.

Mingus, M. Changing the Framework: Disability Justice. _Leaving Evidence_ (blog), 2011.

Russell, S. _Human Compatible: Artificial Intelligence and the Problem of Control_. New York: Viking, 2019.

Sen, A. _Development as Freedom_. New York: Knopf, 1999.

Sharpe, C. _In the Wake: On Blackness and Being_. Durham: Duke University Press, 2016.

Srinivasan, R. _Whose Global Village? Rethinking How Technology Shapes Our World_. New York: NYU Press, 2017.

Touam Bona, D. _Fugitif, où cours-tu?_ Paris: PUF, 2016.

Tronto, J. C. _Moral Boundaries: A Political Argument for an Ethic of Care_. New York: Routledge, 1993.

Weyl, E. G.; Tang, A. _Plurality: The Future of Collaborative Technology and Democracy_. 2024. Disponível em: plurality.net (CC0).

Wynter, S. Unsettling the Coloniality of Being/Power/Truth/Freedom: Towards the Human, After Man, Its Overrepresentation. _CR: The New Centennial Review_, v. 3, n. 3, 2003.
